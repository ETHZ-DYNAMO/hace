...
parameter [3:0] LEGUP_loop_pipeline_wait_loop3_1_4 = 4'd4;
parameter [3:0] LEGUP_F_matrix_BB__14_5 = 4'd5;
parameter [3:0] LEGUP_F_matrix_BB__14_6 = 4'd6;
parameter [3:0] LEGUP_F_matrix_BB__16_7 = 4'd7;
parameter [3:0] LEGUP_F_matrix_BB__16_8 = 4'd8;
parameter [3:0] LEGUP_F_matrix_BB__18_9 = 4'd9;
...
reg  loop3_1_state_stall_0;
reg  loop3_1_state_enable_0;
reg  loop3_1_valid_bit_1;
reg  loop3_1_state_stall_1;
reg  loop3_1_state_enable_1;
reg  loop3_1_valid_bit_2;
reg  loop3_1_state_stall_2;
reg  loop3_1_state_enable_2;
reg  loop3_1_valid_bit_3;
reg  loop3_1_state_stall_3;
reg  loop3_1_state_enable_3;
reg  loop3_1_II_counter;
reg  loop3_1_start;
reg  loop3_1_activate_pipeline;
reg [31:0] matrix_5_6_reg_stage1;
reg [31:0] matrix_5_8_reg_stage1;
reg  loop3_1_pipeline_exit_cond;
reg [31:0] loop3_1_inductionVar_stage0;
reg  loop3_1_active;
reg  loop3_1_begin_pipeline;
reg  loop3_1_epilogue;
reg  loop3_1_pipeline_finish;
reg  loop3_1_only_last_stage_enabled;
reg  loop3_1_pipeline_finish_reg;
...
/*   %11 = mul nsw i32 %9, %10, !legup.pipeline.start_time !7, !legup.pipeline.avail_time !9, !legup.pipeline.stage !7, !MSB !6, !LSB !3, !extendFrom !6*/
...
LEGUP_F_matrix_BB__14_5:
		next_state = LEGUP_F_matrix_BB__14_6;
LEGUP_F_matrix_BB__14_6:
	if ((fsm_stall == 1'd0) && (matrix_14_exitcond6 == 1'd1))
		next_state = LEGUP_F_matrix_BB__16_7;
	else if ((fsm_stall == 1'd0) && (matrix_14_exitcond6 == 1'd0))
		next_state = LEGUP_F_matrix_BB__3_2;
LEGUP_F_matrix_BB__16_7:
		next_state = LEGUP_F_matrix_BB__16_8;
LEGUP_F_matrix_BB__16_8:
	if ((fsm_stall == 1'd0) && (matrix_16_exitcond == 1'd1))
		next_state = LEGUP_F_matrix_BB__18_9;
	else if ((fsm_stall == 1'd0) && (matrix_16_exitcond == 1'd0))
		next_state = LEGUP_F_matrix_BB__1_1;
LEGUP_F_matrix_BB__18_9:
		next_state = LEGUP_0;
...
LEGUP_F_matrix_BB__3_3:
		next_state = LEGUP_loop_pipeline_wait_loop3_1_4;
LEGUP_loop_pipeline_wait_loop3_1_4:
	if ((fsm_stall == 1'd0) && (loop3_1_pipeline_finish == 1'd1))
		next_state = LEGUP_F_matrix_BB__14_5;
	else if ((fsm_stall == 1'd0) && (loop3_1_pipeline_finish == 1'd1))
		next_state = LEGUP_F_matrix_BB__14_5;
default:
	next_state = cur_state;
endcase
...
always @(*) begin
	/* matrix: %1*/
	/*   %i.04 = phi i32 [ 0, %0 ], [ %17, %16 ], !MSB !4, !LSB !3, !extendFrom !4*/
	if ((((cur_state == LEGUP_0) & (fsm_stall == 1'd0)) & (start == 1'd1))) begin
		matrix_1_i04 = 32'd0;
	end
	/* matrix: %1*/
	/*   %i.04 = phi i32 [ 0, %0 ], [ %17, %16 ], !MSB !4, !LSB !3, !extendFrom !4*/
	else /* if ((((cur_state == LEGUP_F_matrix_BB__16_8) & (fsm_stall == 1'd0)) & (matrix_16_exitcond == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* matrix: %1*/
	/*   %i.04 = phi i32 [ 0, %0 ], [ %17, %16 ], !MSB !4, !LSB !3, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_matrix_BB__16_8) & (fsm_stall == 1'd0)) & (matrix_16_exitcond == 1'd0))) begin
		matrix_1_i04_reg <= matrix_1_i04;
	end
end
always @(*) begin
	/* matrix: %1*/
	/*   %2 = mul i32 %i.04, 32, !MSB !5, !LSB !4, !extendFrom !5*/
...
always @(*) begin
	/* matrix: %3*/
	/*   %j.03 = phi i32 [ 0, %1 ], [ %15, %14 ], !MSB !6, !LSB !3, !extendFrom !6*/
	if (((cur_state == LEGUP_F_matrix_BB__1_1) & (fsm_stall == 1'd0))) begin
		matrix_3_j03 = 32'd0;
	end
	/* matrix: %3*/
	/*   %j.03 = phi i32 [ 0, %1 ], [ %15, %14 ], !MSB !6, !LSB !3, !extendFrom !6*/
	else /* if ((((cur_state == LEGUP_F_matrix_BB__14_6) & (fsm_stall == 1'd0)) & (matrix_14_exitcond6 == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* matrix: %3*/
	/*   %j.03 = phi i32 [ 0, %1 ], [ %15, %14 ], !MSB !6, !LSB !3, !extendFrom !6*/
	if ((((cur_state == LEGUP_F_matrix_BB__14_6) & (fsm_stall == 1'd0)) & (matrix_14_exitcond6 == 1'd0))) begin
		matrix_3_j03_reg <= matrix_3_j03;
	end
end
always @(*) begin
	/* matrix: %3*/
	/*   %4 = add i32 %2, %j.03, !MSB !6, !LSB !3, !extendFrom !6*/
...
always @(*) begin
	/* matrix: %3*/
	/*   %scevgep4 = getelementptr i32* %out_c, i32 %4, !MSB !2, !LSB !3, !extendFrom !2*/
...
always @(*) begin
	/* matrix: %5*/
	/*   %sum_mult.02 = phi i32 [ 0, %3 ], [ %12, %5 ], !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7, !MSB !6, !LSB !3, !extendFrom !6
	start_time: 2 avail_time: 2 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 2 % 1 = 0*/
	if (loop3_1_state_enable_3) begin
		matrix_5_sum_mult02 = matrix_5_12;
	end
	/* matrix: %5*/
	/*   %sum_mult.02 = phi i32 [ 0, %3 ], [ %12, %5 ], !legup.pipeline.start_time !7, !legup.pipeline.avail_time !7, !legup.pipeline.stage !7, !MSB !6, !LSB !3, !extendFrom !6
	start_time: 2 avail_time: 2 stage: 2 II: 1 start_ii_state = 2 % 1 = 0 avail_ii_state = 2 % 1 = 0*/
	else /* if (((cur_state == LEGUP_F_matrix_BB__3_3) & (fsm_stall == 1'd0))) */ begin
...
always @(*) begin
	/* matrix: %5*/
	/*   %6 = add i32 %2, %k.01, !legup.pipeline.start_time !3, !legup.pipeline.avail_time !3, !legup.pipeline.stage !3, !MSB !6, !LSB !3, !extendFrom !6
	start_time: 0 avail_time: 0 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 0 % 1 = 0*/
		matrix_5_6 = ({20'd0,matrix_1_2_reg} + loop3_1_inductionVar_stage0);
end
always @(*) begin
	/* matrix: %5*/
	/*   %scevgep2 = getelementptr i32* %in_a, i32 %6, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !8, !legup.pipeline.stage !8, !MSB !2, !LSB !3, !extendFrom !2
	start_time: 1 avail_time: 1 stage: 1 II: 1 start_ii_state = 1 % 1 = 0 avail_ii_state = 1 % 1 = 0*/
		matrix_5_scevgep2 = (arg_in_a_reg + (4 * matrix_5_6_reg_stage1));
end
always @(*) begin
	/* matrix: %5*/
	/*   %7 = mul i32 %k.01, 32, !legup.pipeline.start_time !3, !legup.pipeline.avail_time !3, !legup.pipeline.stage !3, !MSB !6, !LSB !4, !extendFrom !6
	start_time: 0 avail_time: 0 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 0 % 1 = 0*/
		matrix_5_7 = (loop3_1_inductionVar_stage0 * 32'd32);
end
always @(*) begin
	/* matrix: %5*/
	/*   %8 = add i32 %j.03, %7, !legup.pipeline.start_time !3, !legup.pipeline.avail_time !3, !legup.pipeline.stage !3, !MSB !6, !LSB !3, !extendFrom !6
	start_time: 0 avail_time: 0 stage: 0 II: 1 start_ii_state = 0 % 1 = 0 avail_ii_state = 0 % 1 = 0*/
		matrix_5_8 = (matrix_3_j03_reg + matrix_5_7);
end
always @(*) begin
	/* matrix: %5*/
	/*   %scevgep = getelementptr i32* %in_b, i32 %8, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !8, !legup.pipeline.stage !8, !MSB !2, !LSB !3, !extendFrom !2
	start_time: 1 avail_time: 1 stage: 1 II: 1 start_ii_state = 1 % 1 = 0 avail_ii_state = 1 % 1 = 0*/
		matrix_5_scevgep = (arg_in_b_reg + (4 * matrix_5_8_reg_stage1));
end
always @(*) begin
	/* matrix: %5*/
	/*   %9 = load i32* %scevgep2, align 4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !7, !legup.pipeline.stage !8, !MSB !6, !LSB !3, !extendFrom !6
	start_time: 1 avail_time: 2 stage: 1 II: 1 start_ii_state = 1 % 1 = 0 avail_ii_state = 2 % 1 = 0*/
		matrix_5_9 = main_0_in_a_out_a;
end
always @(*) begin
	/* matrix: %5*/
	/*   %10 = load i32* %scevgep, align 4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !7, !legup.pipeline.stage !8, !MSB !6, !LSB !3, !extendFrom !6
	start_time: 1 avail_time: 2 stage: 1 II: 1 start_ii_state = 1 % 1 = 0 avail_ii_state = 2 % 1 = 0*/
...
always @(*) begin
	/* matrix: %5*/
	/*   %12 = add nsw i32 %sum_mult.02, %11, !legup.pipeline.start_time !9, !legup.pipeline.avail_time !9, !legup.pipeline.stage !9, !MSB !6, !LSB !3, !extendFrom !6
...
always @(*) begin
	/* matrix: %14*/
	/*   %.lcssa = phi i32 [ %12, %5 ], !MSB !6, !LSB !3, !extendFrom !6*/
	if ((((cur_state == LEGUP_loop_pipeline_wait_loop3_1_4) & (fsm_stall == 1'd0)) & (loop3_1_pipeline_finish == 1'd1))) begin
		matrix_14_lcssa = matrix_5_12;
	end
	/* matrix: %14*/
	/*   %.lcssa = phi i32 [ %12, %5 ], !MSB !6, !LSB !3, !extendFrom !6*/
	else /* if ((((cur_state == LEGUP_loop_pipeline_wait_loop3_1_4) & (fsm_stall == 1'd0)) & (loop3_1_pipeline_finish == 1'd1))) */ begin
		matrix_14_lcssa = matrix_5_12;
	end
end
always @(posedge clk) begin
...
always @(*) begin
	/* matrix: %14*/
	/*   %15 = add nsw i32 %j.03, 1, !MSB !6, !LSB !3, !extendFrom !6*/
		matrix_14_15 = (matrix_3_j03_reg + 32'd1);
end
always @(posedge clk) begin
	/* matrix: %14*/
	/*   %15 = add nsw i32 %j.03, 1, !MSB !6, !LSB !3, !extendFrom !6*/
	if ((cur_state == LEGUP_F_matrix_BB__14_5)) begin
		matrix_14_15_reg <= matrix_14_15;
	end
end
always @(*) begin
	/* matrix: %14*/
	/*   %exitcond6 = icmp eq i32 %15, 32, !MSB !3, !LSB !3, !extendFrom !3*/
		matrix_14_exitcond6 = (matrix_14_15_reg == 32'd32);
end
always @(*) begin
	/* matrix: %16*/
	/*   %17 = add nsw i32 %i.04, 1, !MSB !13, !LSB !3, !extendFrom !13*/
		matrix_16_17 = ({1'd0,matrix_1_i04_reg} + 32'd1);
end
always @(posedge clk) begin
	/* matrix: %16*/
	/*   %17 = add nsw i32 %i.04, 1, !MSB !13, !LSB !3, !extendFrom !13*/
	if ((cur_state == LEGUP_F_matrix_BB__16_7)) begin
		matrix_16_17_reg <= matrix_16_17;
	end
end
always @(*) begin
	/* matrix: %16*/
	/*   %exitcond = icmp eq i32 %17, 32, !MSB !3, !LSB !3, !extendFrom !3*/
		matrix_16_exitcond = (matrix_16_17_reg == 32'd32);
end
always @(posedge clk) begin
	if (~(loop3_1_state_stall_0)) begin
		loop3_1_valid_bit_0 <= ((loop3_1_II_counter == 1'd0) & loop3_1_start);
	end
	if (reset) begin
...
always @(*) begin
	loop3_1_state_stall_0 = 1'd0;
	if (loop3_1_state_stall_1) begin
		loop3_1_state_stall_0 = 1'd1;
	end
end
always @(*) begin
	loop3_1_state_enable_0 = (loop3_1_valid_bit_0 & ~(loop3_1_state_stall_0));
end
always @(posedge clk) begin
	if (~(loop3_1_state_stall_1)) begin
		loop3_1_valid_bit_1 <= loop3_1_state_enable_0;
	end
	if (reset) begin
...
always @(*) begin
	loop3_1_state_stall_1 = 1'd0;
	if (loop3_1_state_stall_2) begin
		loop3_1_state_stall_1 = 1'd1;
	end
end
always @(*) begin
	loop3_1_state_enable_1 = (loop3_1_valid_bit_1 & ~(loop3_1_state_stall_1));
end
always @(posedge clk) begin
	if (~(loop3_1_state_stall_2)) begin
		loop3_1_valid_bit_2 <= loop3_1_state_enable_1;
	end
	if (reset) begin
...
always @(*) begin
	loop3_1_state_stall_2 = 1'd0;
	if (loop3_1_state_stall_3) begin
		loop3_1_state_stall_2 = 1'd1;
	end
end
always @(*) begin
	loop3_1_state_enable_2 = (loop3_1_valid_bit_2 & ~(loop3_1_state_stall_2));
end
always @(posedge clk) begin
	if (~(loop3_1_state_stall_3)) begin
		loop3_1_valid_bit_3 <= loop3_1_state_enable_2;
	end
	if (reset) begin
...
always @(*) begin
	loop3_1_state_stall_3 = 1'd0;
	if (reset) begin
		loop3_1_state_stall_3 = 1'd0;
	end
end
always @(*) begin
	loop3_1_state_enable_3 = (loop3_1_valid_bit_3 & ~(loop3_1_state_stall_3));
end
always @(posedge clk) begin
	loop3_1_II_counter <= (loop3_1_II_counter + 1'd1);
	if (reset) begin
		loop3_1_II_counter <= 1'd0;
	end
	if ((loop3_1_II_counter == 1'd0)) begin
		loop3_1_II_counter <= 1'd0;
	end
end
always @(*) begin
	loop3_1_start = (loop3_1_activate_pipeline | ((loop3_1_active & ~(loop3_1_epilogue)) & ~((loop3_1_state_enable_0 & loop3_1_pipeline_exit_cond))));
	if (reset) begin
		loop3_1_start = 1'd0;
	end
end
always @(*) begin
	loop3_1_activate_pipeline = (((fsm_stall == 1'd0) & loop3_1_begin_pipeline) & ~(loop3_1_active));
end
always @(posedge clk) begin
	if (loop3_1_state_enable_0) begin
		matrix_5_6_reg_stage1 <= matrix_5_6;
	end
end
always @(posedge clk) begin
	if (loop3_1_state_enable_0) begin
		matrix_5_8_reg_stage1 <= matrix_5_8;
	end
end
always @(*) begin
	loop3_1_pipeline_exit_cond = (loop3_1_inductionVar_stage0 == 31);
end
always @(posedge clk) begin
	if (reset) begin
		loop3_1_inductionVar_stage0 <= 0;
	end
	if (loop3_1_activate_pipeline) begin
		loop3_1_inductionVar_stage0 <= 0;
	end
	if (((loop3_1_II_counter == 1'd0) & loop3_1_state_enable_0)) begin
		loop3_1_inductionVar_stage0 <= (loop3_1_inductionVar_stage0 + 1'd1);
	end
end
always @(posedge clk) begin
	if (reset) begin
	...
	if (((~(loop3_1_state_stall_0) & loop3_1_epilogue) & loop3_1_only_last_stage_enabled)) begin
		loop3_1_active <= 1'd0;
	end
end
always @(*) begin
	loop3_1_begin_pipeline = 1'd0;
	if (reset) begin
		loop3_1_begin_pipeline = 1'd0;
	end
	if (((cur_state == LEGUP_F_matrix_BB__3_3) & (fsm_stall == 1'd0))) begin
		loop3_1_begin_pipeline = 1'd1;
	end
end
always @(posedge clk) begin
	if (reset) begin
	...
	if ((loop3_1_state_enable_0 & loop3_1_pipeline_exit_cond)) begin
...
always @(*) begin
	loop3_1_pipeline_finish = (((~(loop3_1_state_stall_0) & loop3_1_epilogue) & loop3_1_only_last_stage_enabled) | loop3_1_pipeline_finish_reg);
end
always @(*) begin
	loop3_1_only_last_stage_enabled = (((~(loop3_1_state_enable_0) & ~(loop3_1_state_enable_1)) & ~(loop3_1_state_enable_2)) & loop3_1_state_enable_3);
end
always @(posedge clk) begin
	loop3_1_pipeline_finish_reg <= loop3_1_pipeline_finish;
	if (reset) begin
		loop3_1_pipeline_finish_reg <= 1'd0;
	end
	if (loop3_1_activate_pipeline) begin
		loop3_1_pipeline_finish_reg <= 1'd0;
	end
...
always @(*) begin
	legup_mult_matrix_5_11_en = ~(loop3_1_state_stall_2);
end
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_matrix_BB__18_9)) begin
...
always @(*) begin
	...
	/*   %9 = load i32* %scevgep2, align 4, !legup.pipeline.start_time !8, !legup.pipeline.avail_time !7, !legup.pipeline.stage !8, !MSB !6, !LSB !3, !extendFrom !6
	start_time: 1 avail_time: 2 stage: 1 II: 1 start_ii_state = 1 % 1 = 0 avail_ii_state = 2 % 1 = 0*/
	if (loop3_1_state_enable_1) begin
		main_0_in_a_enable_a = 1'd1;
	end
end
always @(*) begin
	main_0_in_a_address_a = 10'd0;
	if (loop3_1_valid_bit_1) begin
...
always @(*) begin
	...
	/* matrix: %14*/
	/*   store i32 %.lcssa, i32* %scevgep4, align 4, !MSB !2, !LSB !3, !extendFrom !2*/
	if ((cur_state == LEGUP_F_matrix_BB__14_5)) begin
