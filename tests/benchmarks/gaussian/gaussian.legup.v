...
parameter [3:0] LEGUP_F_gaussian_BB__20_8 = 4'd8;
parameter [3:0] LEGUP_F_gaussian_BB_loopexitloopexitthread_9 = 4'd9;
...
/*   %17 = mul nsw i32 %15, %16, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !4, !legup.pipeline.stage !11, !MSB !8, !LSB !3, !extendFrom !8*/
...
LEGUP_F_gaussian_BB__20_7:
		next_state = LEGUP_F_gaussian_BB__20_8;
LEGUP_F_gaussian_BB__20_8:
...
LEGUP_F_gaussian_BB_loopexitloopexit_3:
	if ((fsm_stall == 1'd0) && (gaussian_loopexitloopexit_exitcond_reg == 1'd1))
		next_state = LEGUP_F_gaussian_BB_loopexitloopexitthread_9;
...
LEGUP_F_gaussian_BB_loopexitloopexitloopexit_1:
		next_state = LEGUP_F_gaussian_BB_loopexitloopexit_2;
LEGUP_F_gaussian_BB_loopexitloopexitthread_9:
		next_state = LEGUP_0;
...
always @(*) begin
	...
	/*   %1 = phi i32 [ 0, %0 ], [ %8, %.loopexit.loopexit.loopexit ], !MSB !4, !LSB !3, !extendFrom !4*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %2 = mul i32 %1, 16, !MSB !5, !LSB !6, !extendFrom !5*/
		gaussian_loopexitloopexit_2 = ({5'd0,gaussian_loopexitloopexit_1_reg} * 32'd16);
end
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %3 = add i32 %2, 33, !MSB !7, !LSB !3, !extendFrom !7*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %5 = add i32 %4, 14, !MSB !8, !LSB !3, !extendFrom !10*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %6 = add i32 %2, 17, !MSB !7, !LSB !3, !extendFrom !7*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %7 = add i32 %1, 1, !MSB !6, !LSB !3, !extendFrom !6*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %scevgep11 = getelementptr i32* %c, i32 %7, !MSB !2, !LSB !3, !extendFrom !2*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %8 = add i32 %1, 1, !MSB !6, !LSB !3, !extendFrom !6*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %exitcond = icmp eq i32 %1, 14, !MSB !3, !LSB !3, !extendFrom !3*/
...
always @(*) begin
	/* gaussian: %.lr.ph*/
	/*   %indvar4 = phi i32 [ %21, %20 ], [ 0, %.lr.ph.preheader ], !MSB !8, !LSB !3, !extendFrom !8*/
	if (((cur_state == LEGUP_F_gaussian_BB_lrphpreheader_4) & (fsm_stall == 1'd0))) begin
		gaussian_lrph_indvar4 = 32'd0;
	end
	/* gaussian: %.lr.ph*/
	/*   %indvar4 = phi i32 [ %21, %20 ], [ 0, %.lr.ph.preheader ], !MSB !8, !LSB !3, !extendFrom !8*/
	else /* if ((((cur_state == LEGUP_F_gaussian_BB__20_8) & (fsm_stall == 1'd0)) & (gaussian_20_exitcond5 == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* gaussian: %.lr.ph*/
	/*   %indvar4 = phi i32 [ %21, %20 ], [ 0, %.lr.ph.preheader ], !MSB !8, !LSB !3, !extendFrom !8*/
	if ((((cur_state == LEGUP_F_gaussian_BB__20_8) & (fsm_stall == 1'd0)) & (gaussian_20_exitcond5 == 1'd0))) begin
		gaussian_lrph_indvar4_reg <= gaussian_lrph_indvar4;
	end
end
always @(*) begin
	/* gaussian: %.lr.ph*/
	/*   %9 = mul i32 %indvar4, 16, !MSB !8, !LSB !6, !extendFrom !8*/
		gaussian_lrph_9 = (gaussian_lrph_indvar4_reg * 32'd16);
end
always @(*) begin
	/* gaussian: %.lr.ph*/
	/*   %10 = add i32 %3, %9, !MSB !8, !LSB !3, !extendFrom !8*/
...
always @(*) begin
	/* gaussian: %11*/
	/*   %12 = add i32 %10, %indvar, !legup.pipeline.start_time !3, !legup.pipeline.avail_time !3, !legup.pipeline.stage !3, !MSB !8, !LSB !3, !extendFrom !8
...
always @(*) begin
	/* gaussian: %11*/
	/*   %scevgep6 = getelementptr i32* %A, i32 %12, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !11, !legup.pipeline.stage !3, !MSB !2, !LSB !3, !extendFrom !2
...
always @(*) begin
	/* gaussian: %11*/
	/*   %13 = add i32 %6, %indvar, !legup.pipeline.start_time !3, !legup.pipeline.avail_time !3, !legup.pipeline.stage !3, !MSB !8, !LSB !3, !extendFrom !8
	start_time: 0 avail_time: 0 stage: 0 II: 2 start_ii_state = 0 % 2 = 0 avail_ii_state = 0 % 2 = 0*/
		gaussian_11_13 = ({22'd0,gaussian_loopexitloopexit_6_reg} + LOOP22_1_inductionVar_stage0);
end
always @(*) begin
	/* gaussian: %11*/
	/*   %scevgep = getelementptr i32* %A, i32 %13, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !11, !legup.pipeline.stage !3, !MSB !2, !LSB !3, !extendFrom !2
	start_time: 1 avail_time: 1 stage: 0 II: 2 start_ii_state = 1 % 2 = 1 avail_ii_state = 1 % 2 = 1*/
		gaussian_11_scevgep = (arg_A_reg + (4 * gaussian_11_13_reg_stage0));
end
always @(*) begin
	/* gaussian: %11*/
	/*   %14 = load i32* %scevgep6, align 4, !legup.pipeline.start_time !12, !legup.pipeline.avail_time !4, !legup.pipeline.stage !11, !MSB !8, !LSB !3, !extendFrom !8
	start_time: 2 avail_time: 3 stage: 1 II: 2 start_ii_state = 2 % 2 = 0 avail_ii_state = 3 % 2 = 1*/
		gaussian_11_14 = main_0_A_out_a;
end
always @(*) begin
	/* gaussian: %11*/
	/*   %15 = load i32* %scevgep11, align 4, !legup.pipeline.start_time !3, !legup.pipeline.avail_time !11, !legup.pipeline.stage !3, !MSB !8, !LSB !3, !extendFrom !8
	start_time: 0 avail_time: 1 stage: 0 II: 2 start_ii_state = 0 % 2 = 0 avail_ii_state = 1 % 2 = 1*/
		gaussian_11_15 = main_0_c_out_a;
end
always @(*) begin
	/* gaussian: %11*/
	/*   %16 = load i32* %scevgep, align 4, !legup.pipeline.start_time !11, !legup.pipeline.avail_time !12, !legup.pipeline.stage !3, !MSB !8, !LSB !3, !extendFrom !8
...
always @(*) begin
	/* gaussian: %11*/
	/*   %18 = sub nsw i32 %14, %17, !legup.pipeline.start_time !4, !legup.pipeline.avail_time !4, !legup.pipeline.stage !11, !MSB !8, !LSB !3, !extendFrom !8
...
always @(*) begin
	/* gaussian: %20*/
	/*   %21 = add i32 %indvar4, 1, !MSB !8, !LSB !3, !extendFrom !8*/
		gaussian_20_21 = (gaussian_lrph_indvar4_reg + 32'd1);
end
always @(posedge clk) begin
	/* gaussian: %20*/
	/*   %21 = add i32 %indvar4, 1, !MSB !8, !LSB !3, !extendFrom !8*/
	if ((cur_state == LEGUP_F_gaussian_BB__20_7)) begin
		gaussian_20_21_reg <= gaussian_20_21;
	end
end
always @(*) begin
	/* gaussian: %20*/
	/*   %exitcond5 = icmp eq i32 %21, %5, !MSB !3, !LSB !3, !extendFrom !3*/
...
always @(posedge clk) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %4 = mul i32 %1, -1, !MSB !8, !LSB !3, !extendFrom !9*/
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_gaussian_BB_loopexitloopexitthread_9)) begin
...
always @(*) begin
	...
	/* gaussian: %11*/
	/*   store i32 %18, i32* %scevgep6, align 4, !legup.pipeline.start_time !4, !legup.pipeline.avail_time !6, !legup.pipeline.stage !11, !MSB !2, !LSB !3, !extendFrom !2
