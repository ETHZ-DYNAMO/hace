...
parameter [3:0] LEGUP_F_gaussian_BB__11_6 = 4'd6;
parameter [3:0] LEGUP_F_gaussian_BB__11_7 = 4'd7;
parameter [3:0] LEGUP_F_gaussian_BB__11_8 = 4'd8;
parameter [3:0] LEGUP_F_gaussian_BB__11_9 = 4'd9;
parameter [3:0] LEGUP_F_gaussian_BB__11_10 = 4'd10;
parameter [3:0] LEGUP_F_gaussian_BB__20_11 = 4'd11;
parameter [3:0] LEGUP_F_gaussian_BB__20_12 = 4'd12;
parameter [3:0] LEGUP_F_gaussian_BB_loopexitloopexitthread_13 = 4'd13;
...
reg [31:0] gaussian_11_indvar;
reg [31:0] gaussian_11_indvar_reg;
reg [31:0] gaussian_11_12;
reg [31:0] gaussian_11_12_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gaussian_11_scevgep6;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gaussian_11_scevgep6_reg;
reg [31:0] gaussian_11_13;
reg [31:0] gaussian_11_13_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gaussian_11_scevgep;
reg [31:0] gaussian_11_14;
reg [31:0] gaussian_11_14_reg;
reg [31:0] gaussian_11_15;
reg [31:0] gaussian_11_15_reg;
reg [31:0] gaussian_11_16;
reg [31:0] gaussian_11_17;
reg [31:0] gaussian_11_18;
reg [31:0] gaussian_11_19;
reg [31:0] gaussian_11_19_reg;
reg  gaussian_11_exitcond2;
reg  gaussian_11_exitcond2_reg;
reg [31:0] gaussian_20_21;
reg [31:0] gaussian_20_21_reg;
...
/*   %17 = mul nsw i32 %15, %16, !MSB !7, !LSB !2, !extendFrom !7*/
...
LEGUP_F_gaussian_BB__11_10:
	if ((fsm_stall == 1'd0) && (gaussian_11_exitcond2_reg == 1'd1))
		next_state = LEGUP_F_gaussian_BB__20_11;
	else if ((fsm_stall == 1'd0) && (gaussian_11_exitcond2_reg == 1'd0))
		next_state = LEGUP_F_gaussian_BB__11_6;
LEGUP_F_gaussian_BB__11_6:
		next_state = LEGUP_F_gaussian_BB__11_7;
LEGUP_F_gaussian_BB__11_7:
		next_state = LEGUP_F_gaussian_BB__11_8;
LEGUP_F_gaussian_BB__11_8:
		next_state = LEGUP_F_gaussian_BB__11_9;
LEGUP_F_gaussian_BB__11_9:
		next_state = LEGUP_F_gaussian_BB__11_10;
LEGUP_F_gaussian_BB__20_11:
		next_state = LEGUP_F_gaussian_BB__20_12;
LEGUP_F_gaussian_BB__20_12:
...
LEGUP_F_gaussian_BB_loopexitloopexit_3:
	if ((fsm_stall == 1'd0) && (gaussian_loopexitloopexit_exitcond_reg == 1'd1))
		next_state = LEGUP_F_gaussian_BB_loopexitloopexitthread_13;
...
LEGUP_F_gaussian_BB_loopexitloopexitloopexit_1:
		next_state = LEGUP_F_gaussian_BB_loopexitloopexit_2;
LEGUP_F_gaussian_BB_loopexitloopexitthread_13:
		next_state = LEGUP_0;
...
always @(*) begin
	...
	/*   %1 = phi i32 [ 0, %0 ], [ %8, %.loopexit.loopexit.loopexit ], !MSB !3, !LSB !2, !extendFrom !3*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %2 = mul i32 %1, 16, !MSB !4, !LSB !5, !extendFrom !4*/
		gaussian_loopexitloopexit_2 = ({5'd0,gaussian_loopexitloopexit_1_reg} * 32'd16);
end
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %3 = add i32 %2, 33, !MSB !6, !LSB !2, !extendFrom !6*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %5 = add i32 %4, 14, !MSB !7, !LSB !2, !extendFrom !9*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %6 = add i32 %2, 17, !MSB !6, !LSB !2, !extendFrom !6*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %7 = add i32 %1, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %scevgep11 = getelementptr i32* %c, i32 %7, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %8 = add i32 %1, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %exitcond = icmp eq i32 %1, 14, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* gaussian: %.lr.ph*/
	/*   %indvar4 = phi i32 [ %21, %20 ], [ 0, %.lr.ph.preheader ], !MSB !7, !LSB !2, !extendFrom !7*/
	if (((cur_state == LEGUP_F_gaussian_BB_lrphpreheader_4) & (fsm_stall == 1'd0))) begin
		gaussian_lrph_indvar4 = 32'd0;
	end
	/* gaussian: %.lr.ph*/
	/*   %indvar4 = phi i32 [ %21, %20 ], [ 0, %.lr.ph.preheader ], !MSB !7, !LSB !2, !extendFrom !7*/
	else /* if ((((cur_state == LEGUP_F_gaussian_BB__20_12) & (fsm_stall == 1'd0)) & (gaussian_20_exitcond5 == 1'd0))) */ begin
		gaussian_lrph_indvar4 = gaussian_20_21_reg;
	end
end
always @(posedge clk) begin
	/* gaussian: %.lr.ph*/
	...
	/* gaussian: %.lr.ph*/
	/*   %indvar4 = phi i32 [ %21, %20 ], [ 0, %.lr.ph.preheader ], !MSB !7, !LSB !2, !extendFrom !7*/
	if ((((cur_state == LEGUP_F_gaussian_BB__20_12) & (fsm_stall == 1'd0)) & (gaussian_20_exitcond5 == 1'd0))) begin
		gaussian_lrph_indvar4_reg <= gaussian_lrph_indvar4;
	end
end
always @(*) begin
	/* gaussian: %.lr.ph*/
	/*   %9 = mul i32 %indvar4, 16, !MSB !7, !LSB !5, !extendFrom !7*/
		gaussian_lrph_9 = (gaussian_lrph_indvar4_reg * 32'd16);
end
always @(*) begin
	/* gaussian: %.lr.ph*/
	/*   %10 = add i32 %3, %9, !MSB !7, !LSB !2, !extendFrom !7*/
...
always @(*) begin
	/* gaussian: %11*/
	/*   %indvar = phi i32 [ %19, %11 ], [ 0, %.lr.ph ], !MSB !7, !LSB !2, !extendFrom !7*/
	if (((cur_state == LEGUP_F_gaussian_BB_lrph_5) & (fsm_stall == 1'd0))) begin
		gaussian_11_indvar = 32'd0;
	end
	/* gaussian: %11*/
	/*   %indvar = phi i32 [ %19, %11 ], [ 0, %.lr.ph ], !MSB !7, !LSB !2, !extendFrom !7*/
	else /* if ((((cur_state == LEGUP_F_gaussian_BB__11_10) & (fsm_stall == 1'd0)) & (gaussian_11_exitcond2_reg == 1'd0))) */ begin
		gaussian_11_indvar = gaussian_11_19_reg;
	end
end
always @(posedge clk) begin
	/* gaussian: %11*/
	/*   %indvar = phi i32 [ %19, %11 ], [ 0, %.lr.ph ], !MSB !7, !LSB !2, !extendFrom !7*/
	if (((cur_state == LEGUP_F_gaussian_BB_lrph_5) & (fsm_stall == 1'd0))) begin
		gaussian_11_indvar_reg <= gaussian_11_indvar;
	end
	/* gaussian: %11*/
	/*   %indvar = phi i32 [ %19, %11 ], [ 0, %.lr.ph ], !MSB !7, !LSB !2, !extendFrom !7*/
	if ((((cur_state == LEGUP_F_gaussian_BB__11_10) & (fsm_stall == 1'd0)) & (gaussian_11_exitcond2_reg == 1'd0))) begin
		gaussian_11_indvar_reg <= gaussian_11_indvar;
	end
end
always @(*) begin
	/* gaussian: %11*/
	/*   %12 = add i32 %10, %indvar, !MSB !7, !LSB !2, !extendFrom !7*/
		gaussian_11_12 = (gaussian_lrph_10_reg + gaussian_11_indvar_reg);
end
always @(posedge clk) begin
	/* gaussian: %11*/
	/*   %12 = add i32 %10, %indvar, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_6)) begin
		gaussian_11_12_reg <= gaussian_11_12;
	end
end
always @(*) begin
	/* gaussian: %11*/
	/*   %scevgep6 = getelementptr i32* %A, i32 %12, !MSB !1, !LSB !2, !extendFrom !1*/
		gaussian_11_scevgep6 = (arg_A_reg + (4 * gaussian_11_12_reg));
end
always @(posedge clk) begin
	/* gaussian: %11*/
	/*   %scevgep6 = getelementptr i32* %A, i32 %12, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_7)) begin
		gaussian_11_scevgep6_reg <= gaussian_11_scevgep6;
	end
end
always @(*) begin
	/* gaussian: %11*/
	/*   %13 = add i32 %6, %indvar, !MSB !7, !LSB !2, !extendFrom !7*/
		gaussian_11_13 = ({22'd0,gaussian_loopexitloopexit_6_reg} + gaussian_11_indvar_reg);
end
always @(posedge clk) begin
	/* gaussian: %11*/
	/*   %13 = add i32 %6, %indvar, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_6)) begin
		gaussian_11_13_reg <= gaussian_11_13;
	end
end
always @(*) begin
	/* gaussian: %11*/
	/*   %scevgep = getelementptr i32* %A, i32 %13, !MSB !1, !LSB !2, !extendFrom !1*/
		gaussian_11_scevgep = (arg_A_reg + (4 * gaussian_11_13_reg));
end
always @(*) begin
	/* gaussian: %11*/
	/*   %14 = load i32* %scevgep6, align 4, !MSB !7, !LSB !2, !extendFrom !7*/
		gaussian_11_14 = main_0_A_out_a;
end
always @(posedge clk) begin
	/* gaussian: %11*/
	/*   %14 = load i32* %scevgep6, align 4, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_8)) begin
		gaussian_11_14_reg <= gaussian_11_14;
	end
end
always @(*) begin
	/* gaussian: %11*/
	/*   %15 = load i32* %scevgep11, align 4, !MSB !7, !LSB !2, !extendFrom !7*/
...
always @(posedge clk) begin
	...
	/*   %15 = load i32* %scevgep11, align 4, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_7)) begin
		gaussian_11_15_reg <= gaussian_11_15;
	end
end
always @(*) begin
	/* gaussian: %11*/
	/*   %16 = load i32* %scevgep, align 4, !MSB !7, !LSB !2, !extendFrom !7*/
...
always @(*) begin
	/* gaussian: %11*/
	/*   %18 = sub nsw i32 %14, %17, !MSB !7, !LSB !2, !extendFrom !7*/
		gaussian_11_18 = (gaussian_11_14_reg - gaussian_11_17);
end
always @(*) begin
	/* gaussian: %11*/
	/*   %19 = add i32 %indvar, 1, !MSB !7, !LSB !2, !extendFrom !7*/
		gaussian_11_19 = (gaussian_11_indvar_reg + 32'd1);
end
always @(posedge clk) begin
	/* gaussian: %11*/
	/*   %19 = add i32 %indvar, 1, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_6)) begin
		gaussian_11_19_reg <= gaussian_11_19;
	end
end
always @(*) begin
	/* gaussian: %11*/
	/*   %exitcond2 = icmp eq i32 %19, 15, !MSB !2, !LSB !2, !extendFrom !2*/
		gaussian_11_exitcond2 = (gaussian_11_19_reg == 32'd15);
end
always @(posedge clk) begin
	/* gaussian: %11*/
	/*   %exitcond2 = icmp eq i32 %19, 15, !MSB !2, !LSB !2, !extendFrom !2*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_7)) begin
		gaussian_11_exitcond2_reg <= gaussian_11_exitcond2;
	end
end
always @(*) begin
	/* gaussian: %20*/
	/*   %21 = add i32 %indvar4, 1, !MSB !7, !LSB !2, !extendFrom !7*/
		gaussian_20_21 = (gaussian_lrph_indvar4_reg + 32'd1);
end
always @(posedge clk) begin
	/* gaussian: %20*/
	/*   %21 = add i32 %indvar4, 1, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_gaussian_BB__20_11)) begin
		gaussian_20_21_reg <= gaussian_20_21;
	end
end
always @(*) begin
	/* gaussian: %20*/
	/*   %exitcond5 = icmp eq i32 %21, %5, !MSB !2, !LSB !2, !extendFrom !2*/
		gaussian_20_exitcond5 = (gaussian_20_21_reg == $signed(gaussian_loopexitloopexit_5_reg));
end
always @(*) begin
...
always @(posedge clk) begin
	/* gaussian: %.loopexit.loopexit*/
	/*   %4 = mul i32 %1, -1, !MSB !7, !LSB !2, !extendFrom !8*/
...
always @(*) begin
	legup_mult_1_unsigned_32_32_1_0_dataa = gaussian_11_15_reg;
end
always @(*) begin
...
always @(*) begin
	legup_mult_gaussian_11_17_en = ~(fsm_stall);
end
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_gaussian_BB_loopexitloopexitthread_13)) begin
...
always @(*) begin
	...
	/* gaussian: %11*/
	/*   store i32 %18, i32* %scevgep6, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_9)) begin
...
always @(*) begin
	...
	/*   %14 = load i32* %scevgep6, align 4, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_7)) begin
		main_0_A_address_a = (gaussian_11_scevgep6 >>> 3'd2);
	end
	/* gaussian: %11*/
	/*   store i32 %18, i32* %scevgep6, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_gaussian_BB__11_9)) begin
		main_0_A_address_a = (gaussian_11_scevgep6_reg >>> 3'd2);
	end
end
