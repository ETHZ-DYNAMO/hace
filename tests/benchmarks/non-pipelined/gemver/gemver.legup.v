...
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_u1;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_v1;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_u2;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_v2;
...
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_z;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_u1_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_v1_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_u2_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_v2_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_w_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_x_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_y_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_z_reg;
reg  fsm_stall;
reg [5:0] gemver_1_i011;
reg [5:0] gemver_1_i011_reg;
reg [11:0] gemver_1_2;
reg [11:0] gemver_1_2_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_1_scevgep22;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_1_scevgep22_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_1_scevgep21;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_1_scevgep21_reg;
reg [31:0] gemver_3_j010;
reg [31:0] gemver_3_j010_reg;
reg [31:0] gemver_3_4;
reg [31:0] gemver_3_4_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_3_scevgep18;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_3_scevgep18_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_3_scevgep17;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_3_scevgep16;
reg [31:0] gemver_3_5;
reg [31:0] gemver_3_6;
reg [31:0] gemver_3_7;
reg [31:0] gemver_3_8;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_preheader2preheader_scevgep14;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_preheader2preheader_scevgep14_reg;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_18_scevgep11;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_18_scevgep10;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_preheader1_scevgep8;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_preheader1_scevgep8_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_preheader1_scevgep7;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_preheaderpreheader_scevgep5;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_preheaderpreheader_scevgep5_reg;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_34_scevgep3;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] gemver_34_scevgep;
...
/*   %22 = mul nsw i32 %21, %beta, !MSB !5, !LSB !2, !extendFrom !5*/
...
/*   %24 = mul nsw i32 %22, %23, !MSB !5, !LSB !2, !extendFrom !5*/
...
/*   %37 = mul nsw i32 %36, %alpha, !MSB !5, !LSB !2, !extendFrom !5*/
...
/*   %39 = mul nsw i32 %37, %38, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %1*/
	/*   %i.011 = phi i32 [ 0, %0 ], [ %16, %15 ], !MSB !3, !LSB !2, !extendFrom !3*/
...
always @(*) begin
	/* gemver: %1*/
	/*   %2 = mul i32 %i.011, 32, !MSB !4, !LSB !3, !extendFrom !4*/
...
always @(*) begin
	/* gemver: %1*/
	/*   %scevgep22 = getelementptr i32* %u1, i32 %i.011, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* gemver: %1*/
	/*   %scevgep21 = getelementptr i32* %u2, i32 %i.011, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %j.010 = phi i32 [ 0, %1 ], [ %14, %3 ], !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %4 = add i32 %2, %j.010, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %scevgep18 = getelementptr i32* %A, i32 %4, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %scevgep17 = getelementptr i32* %v1, i32 %j.010, !MSB !1, !LSB !2, !extendFrom !1*/
		gemver_3_scevgep17 = (arg_v1_reg + (4 * gemver_3_j010_reg));
end
always @(*) begin
	/* gemver: %3*/
	/*   %scevgep16 = getelementptr i32* %v2, i32 %j.010, !MSB !1, !LSB !2, !extendFrom !1*/
		gemver_3_scevgep16 = (arg_v2_reg + (4 * gemver_3_j010_reg));
end
always @(*) begin
	/* gemver: %3*/
	/*   %5 = load i32* %scevgep18, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_3_5 = main_0_A_out_a;
end
always @(*) begin
	/* gemver: %3*/
	/*   %6 = load i32* %scevgep22, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_3_6 = main_0_u1_out_a;
end
always @(*) begin
	/* gemver: %3*/
	/*   %7 = load i32* %scevgep17, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %9 = add nsw i32 %5, %8, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %11 = load i32* %scevgep16, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %13 = add nsw i32 %9, %12, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_3_13 = (gemver_3_9_reg + gemver_3_12_reg);
end
always @(*) begin
	/* gemver: %3*/
	/*   %14 = add nsw i32 %j.010, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %3*/
	/*   %exitcond25 = icmp eq i32 %14, 32, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* gemver: %15*/
	/*   %16 = add nsw i32 %i.011, 1, !MSB !6, !LSB !2, !extendFrom !6*/
...
always @(*) begin
	/* gemver: %15*/
	/*   %exitcond29 = icmp eq i32 %16, 32, !MSB !2, !LSB !2, !extendFrom !2*/
		gemver_15_exitcond29 = (gemver_15_16_reg == 32'd32);
end
always @(*) begin
	/* gemver: %.preheader2.preheader*/
	/*   %i.19 = phi i32 [ %27, %.preheader2 ], [ 0, %.preheader2.preheader.preheader ], !MSB !3, !LSB !2, !extendFrom !3*/
...
always @(*) begin
	/* gemver: %.preheader2.preheader*/
	/*   %scevgep14 = getelementptr i32* %x, i32 %i.19, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* gemver: %.preheader2.preheader*/
	/*   %17 = load i32* %scevgep14, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_preheader2preheader_17 = main_0_x_out_a;
end
always @(*) begin
	/* gemver: %18*/
	/*   %tmp.08 = phi i32 [ %17, %.preheader2.preheader ], [ %25, %18 ], !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %18*/
	/*   %j.17 = phi i32 [ 0, %.preheader2.preheader ], [ %26, %18 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if (((cur_state == LEGUP_F_gemver_BB_preheader2preheader_11) & (fsm_stall == 1'd0))) begin
		gemver_18_j17 = 32'd0;
	end
	/* gemver: %18*/
...
always @(*) begin
	/* gemver: %18*/
	/*   %19 = mul i32 %j.17, 32, !MSB !5, !LSB !3, !extendFrom !5*/
		gemver_18_19 = (gemver_18_j17_reg * 32'd32);
end
always @(*) begin
	/* gemver: %18*/
	/*   %20 = add i32 %i.19, %19, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %18*/
	/*   %scevgep11 = getelementptr i32* %A, i32 %20, !MSB !1, !LSB !2, !extendFrom !1*/
		gemver_18_scevgep11 = (arg_A_reg + (4 * gemver_18_20_reg));
end
always @(*) begin
	/* gemver: %18*/
	/*   %scevgep10 = getelementptr i32* %y, i32 %j.17, !MSB !1, !LSB !2, !extendFrom !1*/
		gemver_18_scevgep10 = (arg_y_reg + (4 * gemver_18_j17_reg));
end
always @(*) begin
	/* gemver: %18*/
	/*   %21 = load i32* %scevgep11, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %18*/
	/*   %23 = load i32* %scevgep10, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %18*/
	/*   %25 = add nsw i32 %tmp.08, %24, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_18_25 = (gemver_18_tmp08_reg + gemver_18_24);
end
always @(*) begin
	/* gemver: %18*/
	/*   %26 = add nsw i32 %j.17, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %18*/
	/*   %exitcond16 = icmp eq i32 %26, 32, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* gemver: %.preheader2*/
	/*   %.lcssa1 = phi i32 [ %25, %18 ], !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %.preheader2*/
	/*   %27 = add nsw i32 %i.19, 1, !MSB !6, !LSB !2, !extendFrom !6*/
...
always @(*) begin
	/* gemver: %.preheader2*/
	/*   %exitcond21 = icmp eq i32 %27, 32, !MSB !2, !LSB !2, !extendFrom !2*/
		gemver_preheader2_exitcond21 = (gemver_preheader2_27_reg == 32'd32);
end
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %i.26 = phi i32 [ %31, %.preheader1 ], [ 0, %.preheader1.preheader ], !MSB !3, !LSB !2, !extendFrom !3*/
...
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %scevgep8 = getelementptr i32* %x, i32 %i.26, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %scevgep7 = getelementptr i32* %z, i32 %i.26, !MSB !1, !LSB !2, !extendFrom !1*/
		gemver_preheader1_scevgep7 = (arg_z_reg + (4 * {26'd0,gemver_preheader1_i26_reg}));
end
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %28 = load i32* %scevgep8, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_preheader1_28 = main_0_x_out_a;
end
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %29 = load i32* %scevgep7, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_preheader1_29 = main_0_z_out_a;
end
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %30 = add nsw i32 %28, %29, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_preheader1_30 = (gemver_preheader1_28 + gemver_preheader1_29);
end
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %31 = add nsw i32 %i.26, 1, !MSB !6, !LSB !2, !extendFrom !6*/
...
always @(*) begin
	/* gemver: %.preheader1*/
	/*   %exitcond = icmp eq i32 %31, 32, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	...
	/*   %i.35 = phi i32 [ %42, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !3, !LSB !2, !extendFrom !3*/
...
always @(*) begin
	/* gemver: %.preheader.preheader*/
	/*   %32 = mul i32 %i.35, 32, !MSB !4, !LSB !3, !extendFrom !4*/
...
always @(*) begin
	/* gemver: %.preheader.preheader*/
	/*   %scevgep5 = getelementptr i32* %w, i32 %i.35, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* gemver: %.preheader.preheader*/
	/*   %33 = load i32* %scevgep5, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_preheaderpreheader_33 = main_0_w_out_a;
end
always @(*) begin
	/* gemver: %34*/
	/*   %tmp1.04 = phi i32 [ %33, %.preheader.preheader ], [ %40, %34 ], !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %34*/
	/*   %j.23 = phi i32 [ 0, %.preheader.preheader ], [ %41, %34 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if (((cur_state == LEGUP_F_gemver_BB_preheaderpreheader_25) & (fsm_stall == 1'd0))) begin
		gemver_34_j23 = 32'd0;
	end
	/* gemver: %34*/
...
always @(*) begin
	/* gemver: %34*/
	/*   %35 = add i32 %32, %j.23, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %34*/
	/*   %scevgep3 = getelementptr i32* %A, i32 %35, !MSB !1, !LSB !2, !extendFrom !1*/
		gemver_34_scevgep3 = (arg_A_reg + (4 * gemver_34_35_reg));
end
always @(*) begin
	/* gemver: %34*/
	/*   %scevgep = getelementptr i32* %x, i32 %j.23, !MSB !1, !LSB !2, !extendFrom !1*/
		gemver_34_scevgep = (arg_x_reg + (4 * gemver_34_j23_reg));
end
always @(*) begin
	/* gemver: %34*/
	/*   %36 = load i32* %scevgep3, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %34*/
	/*   %38 = load i32* %scevgep, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %34*/
	/*   %40 = add nsw i32 %tmp1.04, %39, !MSB !5, !LSB !2, !extendFrom !5*/
		gemver_34_40 = (gemver_34_tmp104_reg + gemver_34_39);
end
always @(*) begin
	/* gemver: %34*/
	/*   %41 = add nsw i32 %j.23, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %34*/
	/*   %exitcond3 = icmp eq i32 %41, 32, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* gemver: %.preheader*/
	/*   %.lcssa = phi i32 [ %40, %34 ], !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* gemver: %.preheader*/
	/*   %42 = add nsw i32 %i.35, 1, !MSB !6, !LSB !2, !extendFrom !6*/
...
always @(*) begin
	/* gemver: %.preheader*/
	/*   %exitcond7 = icmp eq i32 %42, 32, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	...
	/* gemver: %3*/
	/*   store i32 %13, i32* %scevgep18, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	...
	/* gemver: %.preheader1*/
	/*   store i32 %30, i32* %scevgep8, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_gemver_BB_preheader1_21)) begin
		main_0_x_write_enable_a = 1'd1;
	end
end
