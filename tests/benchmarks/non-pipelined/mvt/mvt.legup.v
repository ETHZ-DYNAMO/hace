...
parameter [3:0] LEGUP_F_mvt_BB__1_1 = 4'd1;
parameter [3:0] LEGUP_F_mvt_BB__1_2 = 4'd2;
parameter [3:0] LEGUP_F_mvt_BB__4_3 = 4'd3;
parameter [3:0] LEGUP_F_mvt_BB__4_4 = 4'd4;
parameter [3:0] LEGUP_F_mvt_BB__11_5 = 4'd5;
parameter [3:0] LEGUP_F_mvt_BB__11_6 = 4'd6;
parameter [3:0] LEGUP_F_mvt_BB_preheaderpreheaderpreheader_7 = 4'd7;
parameter [3:0] LEGUP_F_mvt_BB_preheaderpreheader_8 = 4'd8;
parameter [3:0] LEGUP_F_mvt_BB_preheaderpreheader_9 = 4'd9;
parameter [3:0] LEGUP_F_mvt_BB__14_10 = 4'd10;
parameter [3:0] LEGUP_F_mvt_BB__14_11 = 4'd11;
parameter [3:0] LEGUP_F_mvt_BB__14_12 = 4'd12;
parameter [3:0] LEGUP_F_mvt_BB_preheader_13 = 4'd13;
parameter [3:0] LEGUP_F_mvt_BB_preheader_14 = 4'd14;
parameter [3:0] LEGUP_F_mvt_BB__23_15 = 4'd15;
...
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_x1;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_x2;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_y1;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_y2;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_x1_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_x2_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_y1_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_y2_reg;
reg  fsm_stall;
reg [5:0] mvt_1_i06;
reg [5:0] mvt_1_i06_reg;
reg [11:0] mvt_1_2;
reg [11:0] mvt_1_2_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_1_scevgep11;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_1_scevgep11_reg;
reg [31:0] mvt_1_3;
...
reg [31:0] mvt_4_5;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_4_scevgep8;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_4_scevgep7;
reg [31:0] mvt_4_6;
reg [31:0] mvt_4_6_reg;
reg [31:0] mvt_4_7;
...
reg  mvt_11_exitcond14_reg;
reg [5:0] mvt_preheaderpreheader_i13;
reg [5:0] mvt_preheaderpreheader_i13_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_preheaderpreheader_scevgep5;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_preheaderpreheader_scevgep5_reg;
...
reg [31:0] mvt_14_15;
reg [31:0] mvt_14_16;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_14_scevgep3;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] mvt_14_scevgep;
reg [31:0] mvt_14_17;
reg [31:0] mvt_14_18;
reg [31:0] mvt_14_19;
reg [31:0] mvt_14_20;
...
reg  mvt_preheader_exitcond7_reg;
...
/*   %8 = mul nsw i32 %6, %7, !MSB !5, !LSB !2, !extendFrom !5*/
...
/*   %19 = mul nsw i32 %17, %18, !MSB !5, !LSB !2, !extendFrom !5*/
...
LEGUP_F_mvt_BB__11_5:
		next_state = LEGUP_F_mvt_BB__11_6;
LEGUP_F_mvt_BB__11_6:
	if ((fsm_stall == 1'd0) && (mvt_11_exitcond14_reg == 1'd1))
		next_state = LEGUP_F_mvt_BB_preheaderpreheaderpreheader_7;
	else if ((fsm_stall == 1'd0) && (mvt_11_exitcond14_reg == 1'd0))
		next_state = LEGUP_F_mvt_BB__1_1;
LEGUP_F_mvt_BB__14_10:
		next_state = LEGUP_F_mvt_BB__14_11;
LEGUP_F_mvt_BB__14_11:
		next_state = LEGUP_F_mvt_BB__14_12;
LEGUP_F_mvt_BB__14_12:
	if ((fsm_stall == 1'd0) && (mvt_14_exitcond3_reg == 1'd1))
		next_state = LEGUP_F_mvt_BB_preheader_13;
	else if ((fsm_stall == 1'd0) && (mvt_14_exitcond3_reg == 1'd0))
		next_state = LEGUP_F_mvt_BB__14_10;
LEGUP_F_mvt_BB__1_1:
		next_state = LEGUP_F_mvt_BB__1_2;
LEGUP_F_mvt_BB__1_2:
		next_state = LEGUP_F_mvt_BB__4_3;
LEGUP_F_mvt_BB__23_15:
		next_state = LEGUP_0;
LEGUP_F_mvt_BB__4_3:
		next_state = LEGUP_F_mvt_BB__4_4;
LEGUP_F_mvt_BB__4_4:
	if ((fsm_stall == 1'd0) && (mvt_4_exitcond_reg == 1'd1))
		next_state = LEGUP_F_mvt_BB__11_5;
	else if ((fsm_stall == 1'd0) && (mvt_4_exitcond_reg == 1'd0))
		next_state = LEGUP_F_mvt_BB__4_3;
LEGUP_F_mvt_BB_preheader_13:
		next_state = LEGUP_F_mvt_BB_preheader_14;
LEGUP_F_mvt_BB_preheader_14:
	if ((fsm_stall == 1'd0) && (mvt_preheader_exitcond7_reg == 1'd1))
		next_state = LEGUP_F_mvt_BB__23_15;
	else if ((fsm_stall == 1'd0) && (mvt_preheader_exitcond7_reg == 1'd0))
		next_state = LEGUP_F_mvt_BB_preheaderpreheader_8;
LEGUP_F_mvt_BB_preheaderpreheader_8:
		next_state = LEGUP_F_mvt_BB_preheaderpreheader_9;
LEGUP_F_mvt_BB_preheaderpreheader_9:
		next_state = LEGUP_F_mvt_BB__14_10;
LEGUP_F_mvt_BB_preheaderpreheaderpreheader_7:
		next_state = LEGUP_F_mvt_BB_preheaderpreheader_8;
default:
	next_state = cur_state;
endcase
...
always @(*) begin
	/* mvt: %1*/
	/*   %i.06 = phi i32 [ 0, %0 ], [ %12, %11 ], !MSB !3, !LSB !2, !extendFrom !3*/
	if ((((cur_state == LEGUP_0) & (fsm_stall == 1'd0)) & (start == 1'd1))) begin
		mvt_1_i06 = 32'd0;
	end
	/* mvt: %1*/
	/*   %i.06 = phi i32 [ 0, %0 ], [ %12, %11 ], !MSB !3, !LSB !2, !extendFrom !3*/
	else /* if ((((cur_state == LEGUP_F_mvt_BB__11_6) & (fsm_stall == 1'd0)) & (mvt_11_exitcond14_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* mvt: %1*/
	/*   %i.06 = phi i32 [ 0, %0 ], [ %12, %11 ], !MSB !3, !LSB !2, !extendFrom !3*/
	if ((((cur_state == LEGUP_F_mvt_BB__11_6) & (fsm_stall == 1'd0)) & (mvt_11_exitcond14_reg == 1'd0))) begin
		mvt_1_i06_reg <= mvt_1_i06;
	end
end
always @(*) begin
	/* mvt: %1*/
	/*   %2 = mul i32 %i.06, 32, !MSB !4, !LSB !3, !extendFrom !4*/
...
always @(*) begin
	/* mvt: %1*/
	/*   %scevgep11 = getelementptr i32* %x1, i32 %i.06, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* mvt: %1*/
	/*   %3 = load i32* %scevgep11, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_1_3 = main_0_x1_out_a;
end
always @(*) begin
	/* mvt: %4*/
	/*   %tmp.05 = phi i32 [ %3, %1 ], [ %9, %4 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if (((cur_state == LEGUP_F_mvt_BB__1_2) & (fsm_stall == 1'd0))) begin
		mvt_4_tmp05 = mvt_1_3;
	end
	/* mvt: %4*/
	/*   %tmp.05 = phi i32 [ %3, %1 ], [ %9, %4 ], !MSB !5, !LSB !2, !extendFrom !5*/
	else /* if ((((cur_state == LEGUP_F_mvt_BB__4_4) & (fsm_stall == 1'd0)) & (mvt_4_exitcond_reg == 1'd0))) */ begin
		mvt_4_tmp05 = mvt_4_9;
	end
end
always @(posedge clk) begin
	...
	/* mvt: %4*/
	/*   %tmp.05 = phi i32 [ %3, %1 ], [ %9, %4 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if ((((cur_state == LEGUP_F_mvt_BB__4_4) & (fsm_stall == 1'd0)) & (mvt_4_exitcond_reg == 1'd0))) begin
		mvt_4_tmp05_reg <= mvt_4_tmp05;
	end
end
always @(*) begin
	/* mvt: %4*/
	/*   %j.04 = phi i32 [ 0, %1 ], [ %10, %4 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if (((cur_state == LEGUP_F_mvt_BB__1_2) & (fsm_stall == 1'd0))) begin
		mvt_4_j04 = 32'd0;
	end
	/* mvt: %4*/
...
always @(*) begin
	/* mvt: %4*/
	/*   %5 = add i32 %2, %j.04, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_4_5 = ({20'd0,mvt_1_2_reg} + mvt_4_j04_reg);
end
always @(*) begin
	/* mvt: %4*/
	/*   %scevgep8 = getelementptr i32* %A, i32 %5, !MSB !1, !LSB !2, !extendFrom !1*/
		mvt_4_scevgep8 = (arg_A_reg + (4 * mvt_4_5));
end
always @(*) begin
	/* mvt: %4*/
	/*   %scevgep7 = getelementptr i32* %y1, i32 %j.04, !MSB !1, !LSB !2, !extendFrom !1*/
		mvt_4_scevgep7 = (arg_y1_reg + (4 * mvt_4_j04_reg));
end
always @(*) begin
	/* mvt: %4*/
	/*   %6 = load i32* %scevgep8, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* mvt: %4*/
	/*   %7 = load i32* %scevgep7, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* mvt: %4*/
	/*   %9 = add nsw i32 %tmp.05, %8, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_4_9 = (mvt_4_tmp05_reg + mvt_4_8);
end
always @(*) begin
	/* mvt: %4*/
	/*   %10 = add nsw i32 %j.04, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* mvt: %4*/
	/*   %exitcond = icmp eq i32 %10, 32, !MSB !2, !LSB !2, !extendFrom !2*/
		mvt_4_exitcond = (mvt_4_10 == 32'd32);
end
always @(posedge clk) begin
	/* mvt: %4*/
	/*   %exitcond = icmp eq i32 %10, 32, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* mvt: %11*/
	/*   %.lcssa1 = phi i32 [ %9, %4 ], !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_11_lcssa1 = mvt_4_9;
end
always @(posedge clk) begin
	/* mvt: %11*/
	/*   %.lcssa1 = phi i32 [ %9, %4 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if ((((cur_state == LEGUP_F_mvt_BB__4_4) & (fsm_stall == 1'd0)) & (mvt_4_exitcond_reg == 1'd1))) begin
		mvt_11_lcssa1_reg <= mvt_11_lcssa1;
	end
end
always @(*) begin
	/* mvt: %11*/
	/*   %12 = add nsw i32 %i.06, 1, !MSB !6, !LSB !2, !extendFrom !6*/
		mvt_11_12 = ({1'd0,mvt_1_i06_reg} + 32'd1);
end
always @(posedge clk) begin
	/* mvt: %11*/
	/*   %12 = add nsw i32 %i.06, 1, !MSB !6, !LSB !2, !extendFrom !6*/
	if ((cur_state == LEGUP_F_mvt_BB__11_5)) begin
		mvt_11_12_reg <= mvt_11_12;
	end
end
always @(*) begin
	/* mvt: %11*/
	/*   %exitcond14 = icmp eq i32 %12, 32, !MSB !2, !LSB !2, !extendFrom !2*/
		mvt_11_exitcond14 = (mvt_11_12 == 32'd32);
end
always @(posedge clk) begin
	/* mvt: %11*/
	/*   %exitcond14 = icmp eq i32 %12, 32, !MSB !2, !LSB !2, !extendFrom !2*/
	if ((cur_state == LEGUP_F_mvt_BB__11_5)) begin
		mvt_11_exitcond14_reg <= mvt_11_exitcond14;
	end
end
always @(*) begin
	/* mvt: %.preheader.preheader*/
	/*   %i.13 = phi i32 [ %22, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !3, !LSB !2, !extendFrom !3*/
	if (((cur_state == LEGUP_F_mvt_BB_preheaderpreheaderpreheader_7) & (fsm_stall == 1'd0))) begin
		mvt_preheaderpreheader_i13 = 32'd0;
	end
	/* mvt: %.preheader.preheader*/
	/*   %i.13 = phi i32 [ %22, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !3, !LSB !2, !extendFrom !3*/
	else /* if ((((cur_state == LEGUP_F_mvt_BB_preheader_14) & (fsm_stall == 1'd0)) & (mvt_preheader_exitcond7_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* mvt: %.preheader.preheader*/
	/*   %i.13 = phi i32 [ %22, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !3, !LSB !2, !extendFrom !3*/
	if ((((cur_state == LEGUP_F_mvt_BB_preheader_14) & (fsm_stall == 1'd0)) & (mvt_preheader_exitcond7_reg == 1'd0))) begin
		mvt_preheaderpreheader_i13_reg <= mvt_preheaderpreheader_i13;
	end
end
always @(*) begin
	/* mvt: %.preheader.preheader*/
	/*   %scevgep5 = getelementptr i32* %x2, i32 %i.13, !MSB !1, !LSB !2, !extendFrom !1*/
		mvt_preheaderpreheader_scevgep5 = (arg_x2_reg + (4 * {26'd0,mvt_preheaderpreheader_i13_reg}));
end
always @(posedge clk) begin
	/* mvt: %.preheader.preheader*/
	/*   %scevgep5 = getelementptr i32* %x2, i32 %i.13, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_mvt_BB_preheaderpreheader_8)) begin
		mvt_preheaderpreheader_scevgep5_reg <= mvt_preheaderpreheader_scevgep5;
	end
end
always @(*) begin
	/* mvt: %.preheader.preheader*/
	/*   %13 = load i32* %scevgep5, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_preheaderpreheader_13 = main_0_x2_out_a;
end
always @(*) begin
	/* mvt: %14*/
	/*   %tmp1.02 = phi i32 [ %13, %.preheader.preheader ], [ %20, %14 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if (((cur_state == LEGUP_F_mvt_BB_preheaderpreheader_9) & (fsm_stall == 1'd0))) begin
		mvt_14_tmp102 = mvt_preheaderpreheader_13;
	end
	/* mvt: %14*/
	/*   %tmp1.02 = phi i32 [ %13, %.preheader.preheader ], [ %20, %14 ], !MSB !5, !LSB !2, !extendFrom !5*/
	else /* if ((((cur_state == LEGUP_F_mvt_BB__14_12) & (fsm_stall == 1'd0)) & (mvt_14_exitcond3_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* mvt: %14*/
	/*   %tmp1.02 = phi i32 [ %13, %.preheader.preheader ], [ %20, %14 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if ((((cur_state == LEGUP_F_mvt_BB__14_12) & (fsm_stall == 1'd0)) & (mvt_14_exitcond3_reg == 1'd0))) begin
		mvt_14_tmp102_reg <= mvt_14_tmp102;
	end
end
always @(*) begin
	/* mvt: %14*/
	/*   %j.11 = phi i32 [ 0, %.preheader.preheader ], [ %21, %14 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if (((cur_state == LEGUP_F_mvt_BB_preheaderpreheader_9) & (fsm_stall == 1'd0))) begin
		mvt_14_j11 = 32'd0;
	end
	/* mvt: %14*/
...
always @(*) begin
	/* mvt: %14*/
	/*   %15 = mul i32 %j.11, 32, !MSB !5, !LSB !3, !extendFrom !5*/
		mvt_14_15 = (mvt_14_j11_reg * 32'd32);
end
always @(*) begin
	/* mvt: %14*/
	/*   %16 = add i32 %i.13, %15, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_14_16 = ({26'd0,mvt_preheaderpreheader_i13_reg} + mvt_14_15);
end
always @(*) begin
	/* mvt: %14*/
	/*   %scevgep3 = getelementptr i32* %A, i32 %16, !MSB !1, !LSB !2, !extendFrom !1*/
		mvt_14_scevgep3 = (arg_A_reg + (4 * mvt_14_16));
end
always @(*) begin
	/* mvt: %14*/
	/*   %scevgep = getelementptr i32* %y2, i32 %j.11, !MSB !1, !LSB !2, !extendFrom !1*/
		mvt_14_scevgep = (arg_y2_reg + (4 * mvt_14_j11_reg));
end
always @(*) begin
	/* mvt: %14*/
	/*   %17 = load i32* %scevgep3, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_14_17 = main_0_A_out_a;
end
always @(*) begin
	/* mvt: %14*/
	/*   %18 = load i32* %scevgep, align 4, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* mvt: %14*/
	/*   %20 = add nsw i32 %tmp1.02, %19, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_14_20 = (mvt_14_tmp102_reg + mvt_14_19);
end
always @(*) begin
	/* mvt: %14*/
	/*   %21 = add nsw i32 %j.11, 1, !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_14_21 = (mvt_14_j11_reg + 32'd1);
end
always @(posedge clk) begin
	/* mvt: %14*/
	/*   %21 = add nsw i32 %j.11, 1, !MSB !5, !LSB !2, !extendFrom !5*/
	if ((cur_state == LEGUP_F_mvt_BB__14_10)) begin
		mvt_14_21_reg <= mvt_14_21;
	end
end
always @(*) begin
	/* mvt: %14*/
	/*   %exitcond3 = icmp eq i32 %21, 32, !MSB !2, !LSB !2, !extendFrom !2*/
		mvt_14_exitcond3 = (mvt_14_21 == 32'd32);
end
always @(posedge clk) begin
	/* mvt: %14*/
	/*   %exitcond3 = icmp eq i32 %21, 32, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* mvt: %.preheader*/
	/*   %.lcssa = phi i32 [ %20, %14 ], !MSB !5, !LSB !2, !extendFrom !5*/
		mvt_preheader_lcssa = mvt_14_20;
end
always @(posedge clk) begin
	/* mvt: %.preheader*/
	/*   %.lcssa = phi i32 [ %20, %14 ], !MSB !5, !LSB !2, !extendFrom !5*/
	if ((((cur_state == LEGUP_F_mvt_BB__14_12) & (fsm_stall == 1'd0)) & (mvt_14_exitcond3_reg == 1'd1))) begin
		mvt_preheader_lcssa_reg <= mvt_preheader_lcssa;
	end
end
always @(*) begin
	/* mvt: %.preheader*/
	/*   %22 = add nsw i32 %i.13, 1, !MSB !6, !LSB !2, !extendFrom !6*/
		mvt_preheader_22 = ({1'd0,mvt_preheaderpreheader_i13_reg} + 32'd1);
end
always @(posedge clk) begin
	/* mvt: %.preheader*/
	/*   %22 = add nsw i32 %i.13, 1, !MSB !6, !LSB !2, !extendFrom !6*/
	if ((cur_state == LEGUP_F_mvt_BB_preheader_13)) begin
		mvt_preheader_22_reg <= mvt_preheader_22;
	end
end
always @(*) begin
	/* mvt: %.preheader*/
	/*   %exitcond7 = icmp eq i32 %22, 32, !MSB !2, !LSB !2, !extendFrom !2*/
		mvt_preheader_exitcond7 = (mvt_preheader_22 == 32'd32);
end
always @(posedge clk) begin
	/* mvt: %.preheader*/
	/*   %exitcond7 = icmp eq i32 %22, 32, !MSB !2, !LSB !2, !extendFrom !2*/
	if ((cur_state == LEGUP_F_mvt_BB_preheader_13)) begin
		mvt_preheader_exitcond7_reg <= mvt_preheader_exitcond7;
	end
end
always @(*) begin
...
always @(*) begin
	legup_mult_1_unsigned_32_32_1_0_dataa = mvt_4_6_reg;
end
always @(*) begin
...
always @(*) begin
	legup_mult_1_unsigned_32_32_1_1_datab = mvt_14_18;
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_mvt_BB__23_15)) begin
...
always @(*) begin
	...
	/* mvt: %11*/
	/*   store i32 %.lcssa1, i32* %scevgep11, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_mvt_BB__11_5)) begin
