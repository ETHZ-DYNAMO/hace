...
parameter [5:0] LEGUP_F_kmp_BB__1_5 = 6'd5;
parameter [5:0] LEGUP_F_kmp_BB_lrph14preheader_6 = 6'd6;
parameter [5:0] LEGUP_F_kmp_BB_lrph14_7 = 6'd7;
parameter [5:0] LEGUP_F_kmp_BB_lrph14_8 = 6'd8;
parameter [5:0] LEGUP_F_kmp_BB__9_9 = 6'd9;
parameter [5:0] LEGUP_F_kmp_BB__9_10 = 6'd10;
parameter [5:0] LEGUP_F_kmp_BB_threadloopexit_11 = 6'd11;
parameter [5:0] LEGUP_F_kmp_BB_thread_12 = 6'd12;
parameter [5:0] LEGUP_F_kmp_BB_thread_13 = 6'd13;
parameter [5:0] LEGUP_F_kmp_BB_threadthreadloopexit_14 = 6'd14;
parameter [5:0] LEGUP_F_kmp_BB_threadthread_15 = 6'd15;
parameter [5:0] LEGUP_F_kmp_BB__14_16 = 6'd16;
parameter [5:0] LEGUP_F_kmp_BB__14_17 = 6'd17;
parameter [5:0] LEGUP_F_kmp_BB_preheaderpreheaderpreheader_18 = 6'd18;
parameter [5:0] LEGUP_F_kmp_BB_preheaderpreheader_19 = 6'd19;
parameter [5:0] LEGUP_F_kmp_BB_preheaderpreheader_20 = 6'd20;
parameter [5:0] LEGUP_F_kmp_BB_lrphpreheader_21 = 6'd21;
parameter [5:0] LEGUP_F_kmp_BB_lrph_22 = 6'd22;
parameter [5:0] LEGUP_F_kmp_BB_lrph_23 = 6'd23;
parameter [5:0] LEGUP_F_kmp_BB__20_24 = 6'd24;
parameter [5:0] LEGUP_F_kmp_BB__20_25 = 6'd25;
parameter [5:0] LEGUP_F_kmp_BB_thread2loopexit_26 = 6'd26;
parameter [5:0] LEGUP_F_kmp_BB_thread2_27 = 6'd27;
parameter [5:0] LEGUP_F_kmp_BB_thread2_28 = 6'd28;
parameter [5:0] LEGUP_F_kmp_BB_threadpresplitloopexit_29 = 6'd29;
parameter [5:0] LEGUP_F_kmp_BB_threadpresplit_30 = 6'd30;
parameter [5:0] LEGUP_F_kmp_BB__27_31 = 6'd31;
parameter [5:0] LEGUP_F_kmp_BB__27_32 = 6'd32;
parameter [5:0] LEGUP_F_kmp_BB_preheader_33 = 6'd33;
parameter [5:0] LEGUP_F_kmp_BB_preheader_34 = 6'd34;
parameter [5:0] LEGUP_F_kmp_BB__32_35 = 6'd35;
...
input  start;
output reg  finish;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_pattern;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_input;
input [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_kmpNext;
...
reg [5:0] cur_state;
reg [5:0] next_state;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_pattern_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_input_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_kmpNext_reg;
reg  fsm_stall;
...
reg [2:0] kmp_1_2;
reg [2:0] kmp_1_2_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_1_scevgep6;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_1_scevgep5;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_1_scevgep5_reg;
reg [2:0] kmp_1_3;
reg [2:0] kmp_1_3_reg;
reg [31:0] kmp_1_4;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_lrph14_6;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_thread_phitransinsert;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_preheaderpreheader_scevgep;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_lrph_17;
reg [31:0] kmp_lrph_18;
reg  kmp_lrph_19;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_20_21;
reg [31:0] kmp_20_22;
reg  kmp_20_23;
...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] kmp_thread2_phitransinsert32;
...
LEGUP_F_kmp_BB__14_16:
		next_state = LEGUP_F_kmp_BB__14_17;
LEGUP_F_kmp_BB__14_17:
	if ((fsm_stall == 1'd0) && (kmp_14_exitcond8_reg == 1'd1))
		next_state = LEGUP_F_kmp_BB_preheaderpreheaderpreheader_18;
	else if ((fsm_stall == 1'd0) && (kmp_14_exitcond8_reg == 1'd0))
		next_state = LEGUP_F_kmp_BB__1_3;
LEGUP_F_kmp_BB__1_3:
		next_state = LEGUP_F_kmp_BB__1_4;
LEGUP_F_kmp_BB__1_4:
		next_state = LEGUP_F_kmp_BB__1_5;
LEGUP_F_kmp_BB__1_5:
	if ((fsm_stall == 1'd0) && (kmp_1_5_reg == 1'd1))
		next_state = LEGUP_F_kmp_BB_lrph14preheader_6;
	else if ((fsm_stall == 1'd0) && (kmp_1_5_reg == 1'd0))
		next_state = LEGUP_F_kmp_BB_thread_12;
LEGUP_F_kmp_BB__20_24:
		next_state = LEGUP_F_kmp_BB__20_25;
LEGUP_F_kmp_BB__20_25:
	if ((fsm_stall == 1'd0) && (kmp_20_23 == 1'd1))
		next_state = LEGUP_F_kmp_BB_lrph_22;
	else if ((fsm_stall == 1'd0) && (kmp_20_23 == 1'd0))
		next_state = LEGUP_F_kmp_BB_thread2loopexit_26;
LEGUP_F_kmp_BB__27_31:
		next_state = LEGUP_F_kmp_BB__27_32;
LEGUP_F_kmp_BB__27_32:
		next_state = LEGUP_F_kmp_BB_preheader_33;
LEGUP_F_kmp_BB__32_35:
		next_state = LEGUP_0;
LEGUP_F_kmp_BB__9_10:
	if ((fsm_stall == 1'd0) && (kmp_9_11 == 1'd1))
		next_state = LEGUP_F_kmp_BB_lrph14_7;
	else if ((fsm_stall == 1'd0) && (kmp_9_11 == 1'd0))
		next_state = LEGUP_F_kmp_BB_threadloopexit_11;
LEGUP_F_kmp_BB__9_9:
		next_state = LEGUP_F_kmp_BB__9_10;
LEGUP_F_kmp_BB_lrph14_7:
		next_state = LEGUP_F_kmp_BB_lrph14_8;
LEGUP_F_kmp_BB_lrph14_8:
	if ((fsm_stall == 1'd0) && (kmp_lrph14_8 == 1'd1))
		next_state = LEGUP_F_kmp_BB_threadthreadloopexit_14;
	else if ((fsm_stall == 1'd0) && (kmp_lrph14_8 == 1'd0))
		next_state = LEGUP_F_kmp_BB__9_9;
LEGUP_F_kmp_BB_lrph14preheader_6:
		next_state = LEGUP_F_kmp_BB_lrph14_7;
LEGUP_F_kmp_BB_lrph_22:
		next_state = LEGUP_F_kmp_BB_lrph_23;
LEGUP_F_kmp_BB_lrph_23:
	if ((fsm_stall == 1'd0) && (kmp_lrph_19 == 1'd1))
		next_state = LEGUP_F_kmp_BB_threadpresplitloopexit_29;
	else if ((fsm_stall == 1'd0) && (kmp_lrph_19 == 1'd0))
		next_state = LEGUP_F_kmp_BB__20_24;
LEGUP_F_kmp_BB_lrphpreheader_21:
		next_state = LEGUP_F_kmp_BB_lrph_22;
LEGUP_F_kmp_BB_preheader_33:
		next_state = LEGUP_F_kmp_BB_preheader_34;
LEGUP_F_kmp_BB_preheader_34:
	if ((fsm_stall == 1'd0) && (kmp_preheader_exitcond5 == 1'd1))
		next_state = LEGUP_F_kmp_BB__32_35;
...
LEGUP_F_kmp_BB_preheaderpreheader_19:
		next_state = LEGUP_F_kmp_BB_preheaderpreheader_20;
LEGUP_F_kmp_BB_preheaderpreheader_20:
	if ((fsm_stall == 1'd0) && (kmp_preheaderpreheader_16_reg == 1'd1))
		next_state = LEGUP_F_kmp_BB_lrphpreheader_21;
	else if ((fsm_stall == 1'd0) && (kmp_preheaderpreheader_16_reg == 1'd0))
		next_state = LEGUP_F_kmp_BB_thread2_27;
LEGUP_F_kmp_BB_preheaderpreheaderpreheader_18:
		next_state = LEGUP_F_kmp_BB_preheaderpreheader_19;
LEGUP_F_kmp_BB_thread2_27:
		next_state = LEGUP_F_kmp_BB_thread2_28;
LEGUP_F_kmp_BB_thread2_28:
	if ((fsm_stall == 1'd0) && (kmp_thread2_24 == 1'd1))
		next_state = LEGUP_F_kmp_BB_threadpresplit_30;
	else if ((fsm_stall == 1'd0) && (kmp_thread2_24 == 1'd0))
		next_state = LEGUP_F_kmp_BB_preheader_33;
LEGUP_F_kmp_BB_thread2loopexit_26:
		next_state = LEGUP_F_kmp_BB_thread2_27;
LEGUP_F_kmp_BB_thread_12:
		next_state = LEGUP_F_kmp_BB_thread_13;
LEGUP_F_kmp_BB_thread_13:
	if ((fsm_stall == 1'd0) && (kmp_thread_12 == 1'd1))
		next_state = LEGUP_F_kmp_BB_threadthread_15;
	else if ((fsm_stall == 1'd0) && (kmp_thread_12 == 1'd0))
		next_state = LEGUP_F_kmp_BB__14_16;
LEGUP_F_kmp_BB_threadloopexit_11:
		next_state = LEGUP_F_kmp_BB_thread_12;
LEGUP_F_kmp_BB_threadpresplit_30:
	if ((fsm_stall == 1'd0) && (kmp_threadpresplit_26 == 1'd1))
		...
		next_state = LEGUP_F_kmp_BB_preheader_33;
LEGUP_F_kmp_BB_threadpresplitloopexit_29:
		next_state = LEGUP_F_kmp_BB_threadpresplit_30;
LEGUP_F_kmp_BB_threadthread_15:
		next_state = LEGUP_F_kmp_BB__14_16;
LEGUP_F_kmp_BB_threadthreadloopexit_14:
		next_state = LEGUP_F_kmp_BB_threadthread_15;
default:
	next_state = cur_state;
endcase
...
always @(*) begin
	/* kmp: %1*/
	/*   %indvar = phi i32 [ %3, %14 ], [ 0, %0 ], !MSB !3, !LSB !2, !extendFrom !3*/
	if (((cur_state == LEGUP_F_kmp_BB__0_2) & (fsm_stall == 1'd0))) begin
		kmp_1_indvar = 32'd0;
	end
	/* kmp: %1*/
	/*   %indvar = phi i32 [ %3, %14 ], [ 0, %0 ], !MSB !3, !LSB !2, !extendFrom !3*/
	else /* if ((((cur_state == LEGUP_F_kmp_BB__14_17) & (fsm_stall == 1'd0)) & (kmp_14_exitcond8_reg == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %1*/
	/*   %indvar = phi i32 [ %3, %14 ], [ 0, %0 ], !MSB !3, !LSB !2, !extendFrom !3*/
	if ((((cur_state == LEGUP_F_kmp_BB__14_17) & (fsm_stall == 1'd0)) & (kmp_14_exitcond8_reg == 1'd0))) begin
		kmp_1_indvar_reg <= kmp_1_indvar;
	end
end
always @(*) begin
	/* kmp: %1*/
	/*   %k.016 = phi i32 [ 0, %0 ], [ %k.2, %14 ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB__0_2) & (fsm_stall == 1'd0))) begin
		kmp_1_k016 = 32'd0;
	end
	/* kmp: %1*/
...
always @(*) begin
	/* kmp: %1*/
	/*   %2 = add i32 %indvar, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* kmp: %1*/
	/*   %scevgep6 = getelementptr i32* %pattern, i32 %2, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_1_scevgep6 = (arg_pattern_reg + (4 * {29'd0,kmp_1_2_reg}));
end
always @(*) begin
	/* kmp: %1*/
	/*   %scevgep5 = getelementptr i32* %kmpNext, i32 %2, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_1_scevgep5 = (arg_kmpNext_reg + (4 * {29'd0,kmp_1_2_reg}));
end
always @(posedge clk) begin
	/* kmp: %1*/
	/*   %scevgep5 = getelementptr i32* %kmpNext, i32 %2, !MSB !1, !LSB !2, !extendFrom !1*/
...
always @(*) begin
	/* kmp: %1*/
	/*   %3 = add i32 %indvar, 1, !MSB !5, !LSB !2, !extendFrom !5*/
...
always @(*) begin
	/* kmp: %1*/
	/*   %4 = load i32* %scevgep6, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_1_4 = main_0_pattern_out_a;
end
always @(posedge clk) begin
	/* kmp: %1*/
	/*   %4 = load i32* %scevgep6, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB__1_5)) begin
		kmp_1_4_reg <= kmp_1_4;
	end
end
always @(*) begin
	/* kmp: %1*/
	/*   %5 = icmp sgt i32 %k.016, 0, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_1_5 = ($signed(kmp_1_k016_reg) > $signed({30'd0,kmp_1_5_op1_temp}));
end
always @(posedge clk) begin
	/* kmp: %1*/
	/*   %5 = icmp sgt i32 %k.016, 0, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* kmp: %.lr.ph14*/
	/*   %k.113 = phi i32 [ %10, %9 ], [ %k.016, %.lr.ph14.preheader ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_lrph14preheader_6) & (fsm_stall == 1'd0))) begin
		kmp_lrph14_k113 = kmp_1_k016_reg;
	end
	/* kmp: %.lr.ph14*/
	/*   %k.113 = phi i32 [ %10, %9 ], [ %k.016, %.lr.ph14.preheader ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if ((((cur_state == LEGUP_F_kmp_BB__9_10) & (fsm_stall == 1'd0)) & (kmp_9_11 == 1'd1))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %.lr.ph14*/
	/*   %k.113 = phi i32 [ %10, %9 ], [ %k.016, %.lr.ph14.preheader ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB__9_10) & (fsm_stall == 1'd0)) & (kmp_9_11 == 1'd1))) begin
		kmp_lrph14_k113_reg <= kmp_lrph14_k113;
	end
end
always @(*) begin
	/* kmp: %.lr.ph14*/
	/*   %6 = getelementptr inbounds i32* %pattern, i32 %k.113, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_lrph14_6 = (arg_pattern_reg + (4 * kmp_lrph14_k113_reg));
end
always @(*) begin
	/* kmp: %.lr.ph14*/
	/*   %7 = load i32* %6, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_lrph14_7 = main_0_pattern_out_a;
end
always @(*) begin
	/* kmp: %.lr.ph14*/
	/*   %8 = icmp eq i32 %7, %4, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_lrph14_8 = (kmp_lrph14_7 == kmp_1_4_reg);
end
always @(*) begin
	/* kmp: %9*/
	/*   %10 = load i32* %scevgep5, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_9_10 = main_0_kmpNext_out_a;
end
always @(*) begin
	/* kmp: %9*/
	/*   %11 = icmp sgt i32 %10, 0, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_9_11 = ($signed(kmp_9_10) > $signed({30'd0,kmp_9_11_op1_temp}));
end
always @(*) begin
	/* kmp: %.thread.loopexit*/
	/*   %.lcssa3 = phi i32 [ %10, %9 ], !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_threadloopexit_lcssa3 = kmp_9_10;
end
always @(posedge clk) begin
	/* kmp: %.thread.loopexit*/
	/*   %.lcssa3 = phi i32 [ %10, %9 ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB__9_10) & (fsm_stall == 1'd0)) & (kmp_9_11 == 1'd0))) begin
		kmp_threadloopexit_lcssa3_reg <= kmp_threadloopexit_lcssa3;
	end
end
always @(*) begin
	/* kmp: %.thread*/
	/*   %k.1.lcssa = phi i32 [ %k.016, %1 ], [ %.lcssa3, %.thread.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB__1_5) & (fsm_stall == 1'd0)) & (kmp_1_5_reg == 1'd0))) begin
		kmp_thread_k1lcssa = kmp_1_k016_reg;
	end
	/* kmp: %.thread*/
	/*   %k.1.lcssa = phi i32 [ %k.016, %1 ], [ %.lcssa3, %.thread.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if (((cur_state == LEGUP_F_kmp_BB_threadloopexit_11) & (fsm_stall == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %.thread*/
	/*   %k.1.lcssa = phi i32 [ %k.016, %1 ], [ %.lcssa3, %.thread.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_threadloopexit_11) & (fsm_stall == 1'd0))) begin
		kmp_thread_k1lcssa_reg <= kmp_thread_k1lcssa;
	end
end
always @(*) begin
	/* kmp: %.thread*/
	/*   %.phi.trans.insert = getelementptr inbounds i32* %pattern, i32 %k.1.lcssa, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_thread_phitransinsert = (arg_pattern_reg + (4 * kmp_thread_k1lcssa_reg));
end
always @(*) begin
	/* kmp: %.thread*/
	/*   %.pre = load i32* %.phi.trans.insert, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_thread_pre = main_0_pattern_out_a;
end
always @(*) begin
	/* kmp: %.thread*/
	/*   %12 = icmp eq i32 %.pre, %4, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_thread_12 = (kmp_thread_pre == kmp_1_4_reg);
end
always @(*) begin
	/* kmp: %.thread.thread.loopexit*/
	/*   %k.113.lcssa = phi i32 [ %k.113, %.lr.ph14 ], !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_threadthreadloopexit_k113lcssa = kmp_lrph14_k113_reg;
end
always @(posedge clk) begin
	/* kmp: %.thread.thread.loopexit*/
	/*   %k.113.lcssa = phi i32 [ %k.113, %.lr.ph14 ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_lrph14_8) & (fsm_stall == 1'd0)) & (kmp_lrph14_8 == 1'd1))) begin
		kmp_threadthreadloopexit_k113lcssa_reg <= kmp_threadthreadloopexit_k113lcssa;
	end
end
always @(*) begin
	/* kmp: %.thread.thread*/
	/*   %k.13739 = phi i32 [ %k.1.lcssa, %.thread ], [ %k.113.lcssa, %.thread.thread.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_thread_13) & (fsm_stall == 1'd0)) & (kmp_thread_12 == 1'd1))) begin
		kmp_threadthread_k13739 = kmp_thread_k1lcssa_reg;
	end
	/* kmp: %.thread.thread*/
	/*   %k.13739 = phi i32 [ %k.1.lcssa, %.thread ], [ %k.113.lcssa, %.thread.thread.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if (((cur_state == LEGUP_F_kmp_BB_threadthreadloopexit_14) & (fsm_stall == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %.thread.thread*/
	/*   %k.13739 = phi i32 [ %k.1.lcssa, %.thread ], [ %k.113.lcssa, %.thread.thread.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_threadthreadloopexit_14) & (fsm_stall == 1'd0))) begin
		kmp_threadthread_k13739_reg <= kmp_threadthread_k13739;
	end
end
always @(*) begin
	/* kmp: %.thread.thread*/
	/*   %13 = add nsw i32 %k.13739, 1, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_threadthread_13 = (kmp_threadthread_k13739_reg + 32'd1);
end
always @(*) begin
	/* kmp: %14*/
	/*   %k.2 = phi i32 [ %13, %.thread.thread ], [ %k.1.lcssa, %.thread ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_thread_13) & (fsm_stall == 1'd0)) & (kmp_thread_12 == 1'd0))) begin
		kmp_14_k2 = kmp_thread_k1lcssa_reg;
	end
	/* kmp: %14*/
	/*   %k.2 = phi i32 [ %13, %.thread.thread ], [ %k.1.lcssa, %.thread ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if (((cur_state == LEGUP_F_kmp_BB_threadthread_15) & (fsm_stall == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %14*/
	/*   %k.2 = phi i32 [ %13, %.thread.thread ], [ %k.1.lcssa, %.thread ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_threadthread_15) & (fsm_stall == 1'd0))) begin
		kmp_14_k2_reg <= kmp_14_k2;
	end
end
always @(*) begin
	/* kmp: %14*/
	/*   %exitcond8 = icmp eq i32 %3, 3, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_14_exitcond8 = (kmp_1_3_reg == 32'd3);
end
always @(posedge clk) begin
	/* kmp: %14*/
	/*   %exitcond8 = icmp eq i32 %3, 3, !MSB !2, !LSB !2, !extendFrom !2*/
	if ((cur_state == LEGUP_F_kmp_BB__14_16)) begin
		kmp_14_exitcond8_reg <= kmp_14_exitcond8;
	end
end
always @(*) begin
	/* kmp: %.preheader.preheader*/
	/*   %i.012 = phi i32 [ %31, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !6, !LSB !2, !extendFrom !6*/
	if (((cur_state == LEGUP_F_kmp_BB_preheaderpreheaderpreheader_18) & (fsm_stall == 1'd0))) begin
		kmp_preheaderpreheader_i012 = 32'd0;
	end
	/* kmp: %.preheader.preheader*/
	/*   %i.012 = phi i32 [ %31, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !6, !LSB !2, !extendFrom !6*/
	else /* if ((((cur_state == LEGUP_F_kmp_BB_preheader_34) & (fsm_stall == 1'd0)) & (kmp_preheader_exitcond5 == 1'd0))) */ begin
		kmp_preheaderpreheader_i012 = kmp_preheader_31_reg;
	end
end
always @(posedge clk) begin
	/* kmp: %.preheader.preheader*/
	...
	/* kmp: %.preheader.preheader*/
	/*   %i.012 = phi i32 [ %31, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !6, !LSB !2, !extendFrom !6*/
	if ((((cur_state == LEGUP_F_kmp_BB_preheader_34) & (fsm_stall == 1'd0)) & (kmp_preheader_exitcond5 == 1'd0))) begin
		kmp_preheaderpreheader_i012_reg <= kmp_preheaderpreheader_i012;
	end
end
always @(*) begin
	/* kmp: %.preheader.preheader*/
	/*   %q.111 = phi i32 [ %q.4, %.preheader ], [ 0, %.preheader.preheader.preheader ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_preheaderpreheaderpreheader_18) & (fsm_stall == 1'd0))) begin
...
always @(*) begin
	/* kmp: %.preheader.preheader*/
	/*   %scevgep = getelementptr i32* %input, i32 %i.012, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_preheaderpreheader_scevgep = (arg_input_reg + (4 * {22'd0,kmp_preheaderpreheader_i012_reg}));
end
always @(*) begin
	/* kmp: %.preheader.preheader*/
	/*   %15 = load i32* %scevgep, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_preheaderpreheader_15 = main_0_input_out_a;
end
always @(posedge clk) begin
	/* kmp: %.preheader.preheader*/
	/*   %15 = load i32* %scevgep, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB_preheaderpreheader_20)) begin
		kmp_preheaderpreheader_15_reg <= kmp_preheaderpreheader_15;
	end
end
always @(*) begin
	/* kmp: %.preheader.preheader*/
	/*   %16 = icmp sgt i32 %q.111, 0, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_preheaderpreheader_16 = ($signed(kmp_preheaderpreheader_q111_reg) > $signed({30'd0,kmp_preheaderpreheader_16_op1_temp}));
end
always @(posedge clk) begin
	/* kmp: %.preheader.preheader*/
	/*   %16 = icmp sgt i32 %q.111, 0, !MSB !2, !LSB !2, !extendFrom !2*/
...
always @(*) begin
	/* kmp: %.lr.ph*/
	/*   %q.29 = phi i32 [ %22, %20 ], [ %q.111, %.lr.ph.preheader ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_lrphpreheader_21) & (fsm_stall == 1'd0))) begin
		kmp_lrph_q29 = kmp_preheaderpreheader_q111_reg;
	end
	/* kmp: %.lr.ph*/
	/*   %q.29 = phi i32 [ %22, %20 ], [ %q.111, %.lr.ph.preheader ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if ((((cur_state == LEGUP_F_kmp_BB__20_25) & (fsm_stall == 1'd0)) & (kmp_20_23 == 1'd1))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %.lr.ph*/
	/*   %q.29 = phi i32 [ %22, %20 ], [ %q.111, %.lr.ph.preheader ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB__20_25) & (fsm_stall == 1'd0)) & (kmp_20_23 == 1'd1))) begin
		kmp_lrph_q29_reg <= kmp_lrph_q29;
	end
end
always @(*) begin
	/* kmp: %.lr.ph*/
	/*   %17 = getelementptr inbounds i32* %pattern, i32 %q.29, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_lrph_17 = (arg_pattern_reg + (4 * kmp_lrph_q29_reg));
end
always @(*) begin
	/* kmp: %.lr.ph*/
	/*   %18 = load i32* %17, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_lrph_18 = main_0_pattern_out_a;
end
always @(*) begin
	/* kmp: %.lr.ph*/
	/*   %19 = icmp eq i32 %18, %15, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_lrph_19 = (kmp_lrph_18 == kmp_preheaderpreheader_15_reg);
end
always @(*) begin
	/* kmp: %20*/
	/*   %21 = getelementptr inbounds i32* %kmpNext, i32 %q.29, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_20_21 = (arg_kmpNext_reg + (4 * kmp_lrph_q29_reg));
end
always @(*) begin
	/* kmp: %20*/
	/*   %22 = load i32* %21, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_20_22 = main_0_kmpNext_out_a;
end
always @(*) begin
	/* kmp: %20*/
	/*   %23 = icmp sgt i32 %22, 0, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_20_23 = ($signed(kmp_20_22) > $signed({30'd0,kmp_20_23_op1_temp}));
end
always @(*) begin
	/* kmp: %.thread2.loopexit*/
	/*   %.lcssa = phi i32 [ %22, %20 ], !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_thread2loopexit_lcssa = kmp_20_22;
end
always @(posedge clk) begin
	/* kmp: %.thread2.loopexit*/
	/*   %.lcssa = phi i32 [ %22, %20 ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB__20_25) & (fsm_stall == 1'd0)) & (kmp_20_23 == 1'd0))) begin
		kmp_thread2loopexit_lcssa_reg <= kmp_thread2loopexit_lcssa;
	end
end
always @(*) begin
	/* kmp: %.thread2*/
	/*   %q.2.lcssa = phi i32 [ %q.111, %.preheader.preheader ], [ %.lcssa, %.thread2.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_preheaderpreheader_20) & (fsm_stall == 1'd0)) & (kmp_preheaderpreheader_16_reg == 1'd0))) begin
		kmp_thread2_q2lcssa = kmp_preheaderpreheader_q111_reg;
	end
	/* kmp: %.thread2*/
	/*   %q.2.lcssa = phi i32 [ %q.111, %.preheader.preheader ], [ %.lcssa, %.thread2.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if (((cur_state == LEGUP_F_kmp_BB_thread2loopexit_26) & (fsm_stall == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %.thread2*/
	/*   %q.2.lcssa = phi i32 [ %q.111, %.preheader.preheader ], [ %.lcssa, %.thread2.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_thread2loopexit_26) & (fsm_stall == 1'd0))) begin
		kmp_thread2_q2lcssa_reg <= kmp_thread2_q2lcssa;
	end
end
always @(*) begin
	/* kmp: %.thread2*/
	/*   %.phi.trans.insert32 = getelementptr inbounds i32* %pattern, i32 %q.2.lcssa, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_thread2_phitransinsert32 = (arg_pattern_reg + (4 * kmp_thread2_q2lcssa_reg));
end
always @(*) begin
	/* kmp: %.thread2*/
	/*   %.pre33 = load i32* %.phi.trans.insert32, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_thread2_pre33 = main_0_pattern_out_a;
end
always @(*) begin
	/* kmp: %.thread2*/
	/*   %24 = icmp eq i32 %.pre33, %15, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_thread2_24 = (kmp_thread2_pre33 == kmp_preheaderpreheader_15_reg);
end
always @(*) begin
	/* kmp: %thread-pre-split.loopexit*/
	/*   %q.29.lcssa = phi i32 [ %q.29, %.lr.ph ], !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_threadpresplitloopexit_q29lcssa = kmp_lrph_q29_reg;
end
always @(posedge clk) begin
	/* kmp: %thread-pre-split.loopexit*/
	/*   %q.29.lcssa = phi i32 [ %q.29, %.lr.ph ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_lrph_23) & (fsm_stall == 1'd0)) & (kmp_lrph_19 == 1'd1))) begin
		kmp_threadpresplitloopexit_q29lcssa_reg <= kmp_threadpresplitloopexit_q29lcssa;
	end
end
always @(*) begin
	/* kmp: %thread-pre-split*/
	/*   %q.23540 = phi i32 [ %q.2.lcssa, %.thread2 ], [ %q.29.lcssa, %thread-pre-split.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_thread2_28) & (fsm_stall == 1'd0)) & (kmp_thread2_24 == 1'd1))) begin
		kmp_threadpresplit_q23540 = kmp_thread2_q2lcssa_reg;
	end
	/* kmp: %thread-pre-split*/
	/*   %q.23540 = phi i32 [ %q.2.lcssa, %.thread2 ], [ %q.29.lcssa, %thread-pre-split.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if (((cur_state == LEGUP_F_kmp_BB_threadpresplitloopexit_29) & (fsm_stall == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %thread-pre-split*/
	/*   %q.23540 = phi i32 [ %q.2.lcssa, %.thread2 ], [ %q.29.lcssa, %thread-pre-split.loopexit ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB_threadpresplitloopexit_29) & (fsm_stall == 1'd0))) begin
		kmp_threadpresplit_q23540_reg <= kmp_threadpresplit_q23540;
	end
end
always @(*) begin
	/* kmp: %thread-pre-split*/
	/*   %25 = add nsw i32 %q.23540, 1, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_threadpresplit_25 = (kmp_threadpresplit_q23540_reg + 32'd1);
end
always @(*) begin
	/* kmp: %thread-pre-split*/
	/*   %26 = icmp sgt i32 %q.23540, 2, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_threadpresplit_26 = ($signed(kmp_threadpresplit_q23540_reg) > $signed({29'd0,kmp_threadpresplit_26_op1_temp}));
end
always @(*) begin
	/* kmp: %27*/
	/*   %29 = getelementptr inbounds i32* %kmpNext, i32 %q.23540, !MSB !1, !LSB !2, !extendFrom !1*/
		kmp_27_29 = (arg_kmpNext_reg + (4 * kmp_threadpresplit_q23540_reg));
end
always @(*) begin
	/* kmp: %27*/
	/*   %30 = load i32* %29, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
		kmp_27_30 = main_0_kmpNext_out_a;
end
always @(*) begin
	/* kmp: %.preheader*/
	/*   %q.4 = phi i32 [ %30, %27 ], [ %25, %thread-pre-split ], [ %q.2.lcssa, %.thread2 ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_thread2_28) & (fsm_stall == 1'd0)) & (kmp_thread2_24 == 1'd0))) begin
		kmp_preheader_q4 = kmp_thread2_q2lcssa_reg;
	end
	/* kmp: %.preheader*/
	/*   %q.4 = phi i32 [ %30, %27 ], [ %25, %thread-pre-split ], [ %q.2.lcssa, %.thread2 ], !MSB !4, !LSB !2, !extendFrom !4*/
	else if ((((cur_state == LEGUP_F_kmp_BB_threadpresplit_30) & (fsm_stall == 1'd0)) & (kmp_threadpresplit_26 == 1'd0))) begin
		kmp_preheader_q4 = kmp_threadpresplit_25;
	end
	/* kmp: %.preheader*/
	/*   %q.4 = phi i32 [ %30, %27 ], [ %25, %thread-pre-split ], [ %q.2.lcssa, %.thread2 ], !MSB !4, !LSB !2, !extendFrom !4*/
	else /* if (((cur_state == LEGUP_F_kmp_BB__27_32) & (fsm_stall == 1'd0))) */ begin
...
always @(posedge clk) begin
	...
	/* kmp: %.preheader*/
	/*   %q.4 = phi i32 [ %30, %27 ], [ %25, %thread-pre-split ], [ %q.2.lcssa, %.thread2 ], !MSB !4, !LSB !2, !extendFrom !4*/
	if ((((cur_state == LEGUP_F_kmp_BB_threadpresplit_30) & (fsm_stall == 1'd0)) & (kmp_threadpresplit_26 == 1'd0))) begin
		kmp_preheader_q4_reg <= kmp_preheader_q4;
	end
	/* kmp: %.preheader*/
	/*   %q.4 = phi i32 [ %30, %27 ], [ %25, %thread-pre-split ], [ %q.2.lcssa, %.thread2 ], !MSB !4, !LSB !2, !extendFrom !4*/
	if (((cur_state == LEGUP_F_kmp_BB__27_32) & (fsm_stall == 1'd0))) begin
		kmp_preheader_q4_reg <= kmp_preheader_q4;
	end
end
always @(*) begin
	/* kmp: %.preheader*/
	/*   %31 = add nsw i32 %i.012, 1, !MSB !7, !LSB !2, !extendFrom !7*/
		kmp_preheader_31 = ({1'd0,kmp_preheaderpreheader_i012_reg} + 32'd1);
end
always @(posedge clk) begin
	/* kmp: %.preheader*/
	/*   %31 = add nsw i32 %i.012, 1, !MSB !7, !LSB !2, !extendFrom !7*/
	if ((cur_state == LEGUP_F_kmp_BB_preheader_33)) begin
		kmp_preheader_31_reg <= kmp_preheader_31;
	end
end
always @(*) begin
	/* kmp: %.preheader*/
	/*   %exitcond5 = icmp eq i32 %31, 1000, !MSB !2, !LSB !2, !extendFrom !2*/
		kmp_preheader_exitcond5 = (kmp_preheader_31_reg == 32'd1000);
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_kmp_BB__32_35)) begin
...
always @(*) begin
	...
	/* kmp: %0*/
	/*   store i32 0, i32* %kmpNext, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_kmp_BB__0_1)) begin
		main_0_kmpNext_write_enable_a = 1'd1;
	end
	/* kmp: %14*/
	/*   store i32 %k.2, i32* %scevgep5, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
	if ((cur_state == LEGUP_F_kmp_BB__14_16)) begin
		main_0_kmpNext_write_enable_a = 1'd1;
	end
end
...
always @(*) begin
	...
	/* kmp: %9*/
	/*   %10 = load i32* %scevgep5, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB__9_9)) begin
		main_0_kmpNext_enable_a = 1'd1;
	end
	/* kmp: %14*/
	/*   store i32 %k.2, i32* %scevgep5, align 4, !MSB !1, !LSB !2, !extendFrom !1*/
	...
	/* kmp: %20*/
	/*   %22 = load i32* %21, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB__20_24)) begin
		main_0_kmpNext_enable_a = 1'd1;
	end
	/* kmp: %27*/
	/*   %30 = load i32* %29, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB__27_31)) begin
		main_0_kmpNext_enable_a = 1'd1;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/* kmp: %.lr.ph14*/
	/*   %7 = load i32* %6, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB_lrph14_7)) begin
		main_0_pattern_enable_a = 1'd1;
	end
	/* kmp: %.thread*/
	/*   %.pre = load i32* %.phi.trans.insert, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB_thread_12)) begin
		main_0_pattern_enable_a = 1'd1;
	end
	/* kmp: %.lr.ph*/
	/*   %18 = load i32* %17, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB_lrph_22)) begin
		main_0_pattern_enable_a = 1'd1;
	end
	/* kmp: %.thread2*/
	/*   %.pre33 = load i32* %.phi.trans.insert32, align 4, !MSB !4, !LSB !2, !extendFrom !4*/
	if ((cur_state == LEGUP_F_kmp_BB_thread2_27)) begin
		main_0_pattern_enable_a = 1'd1;
	end
end
always @(*) begin
