...
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] arg_addr_reg;
reg  fsm_stall;
reg [9:0] getTanh_1_i01;
reg [9:0] getTanh_1_i01_reg;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] getTanh_1_scevgep;
reg [31:0] getTanh_1_2;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] getTanh_1_3;
reg [`MEMORY_CONTROLLER_ADDR_SIZE-1:0] getTanh_1_3_reg;
...
/*   %7 = mul nsw i32 %4, %4, !MSB !5, !LSB !3, !extendFrom !5*/
...
/*   %9 = mul nsw i32 %8, %4, !MSB !5, !LSB !3, !extendFrom !5*/
...
/*   %10 = mul nsw i32 %9, %4, !MSB !5, !LSB !3, !extendFrom !5*/
...
/*   %12 = mul nsw i32 %11, %4, !MSB !5, !LSB !3, !extendFrom !5*/
...
always @(*) begin
	/* getTanh: %1*/
	/*   %i.01 = phi i32 [ 0, %0 ], [ %14, %13 ], !MSB !4, !LSB !3, !extendFrom !4*/
...
always @(*) begin
	/* getTanh: %1*/
	/*   %scevgep = getelementptr i32* %addr, i32 %i.01, !MSB !2, !LSB !3, !extendFrom !2*/
		getTanh_1_scevgep = (arg_addr_reg + (4 * {22'd0,getTanh_1_i01_reg}));
end
always @(*) begin
	/* getTanh: %1*/
	/*   %2 = load i32* %scevgep, align 4, !MSB !5, !LSB !3, !extendFrom !5*/
		getTanh_1_2 = main_0_b_out_a;
end
always @(*) begin
	/* getTanh: %1*/
	/*   %3 = getelementptr inbounds i32* %A, i32 %2, !MSB !2, !LSB !3, !extendFrom !2*/
...
always @(*) begin
	/* getTanh: %1*/
	/*   %4 = load i32* %3, align 4, !MSB !5, !LSB !3, !extendFrom !5*/
...
always @(*) begin
	/* getTanh: %1*/
	/*   %5 = icmp sgt i32 %4, 7, !MSB !3, !LSB !3, !extendFrom !3*/
		getTanh_1_5 = ($signed(getTanh_1_4) > $signed({28'd0,getTanh_1_5_op1_temp}));
end
always @(*) begin
...
always @(*) begin
	/* getTanh: %6*/
	/*   %8 = add nuw nsw i32 %7, 19, !MSB !5, !LSB !3, !extendFrom !5*/
...
always @(*) begin
	/* getTanh: %6*/
	/*   %11 = add nsw i32 %10, 3, !MSB !5, !LSB !3, !extendFrom !5*/
...
always @(*) begin
	/* getTanh: %13*/
	/*   %result.0 = phi i32 [ %12, %6 ], [ 1, %1 ], !MSB !5, !LSB !3, !extendFrom !5*/
...
always @(*) begin
	/* getTanh: %13*/
	/*   %14 = add nsw i32 %i.01, 1, !MSB !6, !LSB !3, !extendFrom !6*/
...
always @(*) begin
	/* getTanh: %13*/
	/*   %exitcond = icmp eq i32 %14, 1000, !MSB !3, !LSB !3, !extendFrom !3*/
		getTanh_13_exitcond = (getTanh_13_14_reg == 32'd1000);
end
always @(*) begin
	getTanh_1_5_op1_temp = 32'd7;
...
always @(*) begin
	...
	/* getTanh: %13*/
	/*   store i32 %result.0, i32* %3, align 4, !MSB !2, !LSB !3, !extendFrom !2*/
	if ((cur_state == LEGUP_F_getTanh_BB__13_9)) begin
